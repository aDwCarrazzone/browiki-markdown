---
title: "Caça ao Culto de Morroc"
source: https://browiki.org/wiki/Ca%C3%A7a_ao_Culto_de_Morroc
namespace: 0
revision: 42405
...
| **Nv. de base** | 70 |
| **Tipo** | Normal |
| **[Itens](Itens.md "Itens")** | 7511.png 30 [Runas da Escuridão](http://www.divine-pride.net/database/item/7511/)  7563.png 30 [Runas Sangrentas](http://www.divine-pride.net/database/item/7563/)  523.png 30 [Água Benta](http://www.divine-pride.net/database/item/523/)  516.png 20 [Batatas](http://www.divine-pride.net/database/item/516/)  7201.png 30 [Toras](http://www.divine-pride.net/database/item/7201/) |
| **Caça** | 4 [Membros da Dandelion](http://www.divine-pride.net/database/monster/1985/) |
| **Quests anteriores** | [Outra Dimensão](Outra Dimensão.md "Outra Dimensão") |
| Premiação | |
| **[EXP base](Experiência de Base.md "Experiência de Base")** | 120.000 |
| **[EXP classe](Experiência de Classe.md "Experiência de Classe")** | 20.000 |
| **[Itens](Itens.md "Itens")** | 617.png 1 [Velha Caixa Roxa](http://www.divine-pride.net/database/item/617/) 633.png 5 [Batatas Assadas](http://www.divine-pride.net/database/item/633/) |
...
6. Receba o [Registro da Perseguição](http://www.divine-pride.net/database/item/6029/) de Lin, em [Morroc](Morroc.md "Morroc").
7. Entregue os itens para Kidd analisar. O [NPC](NPC.md "NPC") pede tempo, mas você pode clicá-lo logo em seguida.
...
12. Localize o Sr. Defaria (mid\_camp 256,272)
    ...
    - Você receberá o [Pergaminho Mágico Aberto](http://www.divine-pride.net/database/item/14595/). Não use ou perca esse item.
13. Fale com Kidd.
...
17. Fale com Kidd em [Ash Vacuum](Ash Vacuum.md "Ash Vacuum").
18. Volte para a Casa Abandonada e reative o diálogo. Selecione "*Ryan?!*" para voltar ao ponto de retorno.
19. Reencontre Kidd, que dará o [Cristal Sangrento da Escuridão](http://www.divine-pride.net/database/item/6027/).
20. Retorne a Lin, na taverna. Você receberá um código aleatório para cada personagem, anote-o.
21. Digite o código para a Líder do Grupo, Echinacea (mid\_campin 68,185)
    - `SDHF92F-SDF`
    - `VWNM94GVWN90`
    - `CM3-TRDFGHE0`
...
23. Volte com a Echinacea para receber [experiência](Experiência.md "Experiência") e uma [Velha Caixa Roxa](http://www.divine-pride.net/database/item/617/).
    - Fale mais uma vez com Echinacea (mid\_campin 68,185)
24. Reencontre o Sr. Defaria (mid\_camp 256,272)
    - Digite:
      - `Dandelion`
    - Entregue as 20 [Batatas](http://www.divine-pride.net/database/item/516/) e 30 [Toras](http://www.divine-pride.net/database/item/7201/).
25. Reencontre Kidd (mid\_camp 199,311)
26. Retorne ao Sr. Defaria (mid\_camp 256,272)
27. Fale com Echinacea, a Líder do Grupo.
28. Receba 2 [Batata Doce Assada](http://www.divine-pride.net/database/item/549/) do Sr. Defaria (mid\_camp 256,272)
29. Fale com Kidd (mid\_camp 199,311)
30. Retorne ao Sr. Defaria (mid\_camp 256,272) e receba mais 2 [Batata Doce Assada](http://www.divine-pride.net/database/item/549/).
31. Fale com Echinacea (mid\_campin 68,185)
32. Receba 5 [Batatas Assadas](http://www.divine-pride.net/database/item/633/) do Sr. Defaria (mid\_camp 256,272) para finalizar a missão.
    - Essa missão pode ser continuada em [Retorno de Rayan Moore](Retorno de Rayan Moore.md "Retorno de Rayan Moore").
