---
title: "Rufar dos Tambores"
source: https://browiki.org/wiki/Rufar_dos_Tambores
namespace: 0
revision: 46683
...
|  |  |
| --- | --- |
| **Rufar dos Tambores Rufar dos Tambores** | |
| Rufar dos Tambores | |
| **Battle Theme / Tambor Ensordecedor** | |
| **ID** | BD\_DRUMBATTLEFIELD (309) |
| **Tipo** | Suporte |
| **Níveis** | 5 |
| **[SP](SP.md "SP")** | 46 + (Nv. da habilidade × 4) |
...
| **Ícone** | I Rufar dos Tambores |
| **Áudio** | <https://browiki.org/wiki/Arquivo:Rufar_dos_Tambores.mp3> |
| **Pré-requisitos** | |
| - Bardos [Maçãs de Idun](Maçãs de Idun.md "Maçãs de Idun") [Maçãs de Idun](Maçãs de Idun.md "Maçãs de Idun") Nv. 10 - Odaliscas [Dança Cigana](Dança Cigana.md "Dança Cigana") [Dança Cigana](Dança Cigana.md "Dança Cigana") Nv. 10 | |

Inicia um dueto de batalha.

O usuário e membros do [grupo](Grupo.md "Grupo") terão seu [ATQ](ATQ.md "ATQ") e [DEF](DEF.md "DEF") aumentados.

| Nv. | [ATQ](ATQ.md "ATQ") | [DEF](DEF.md "DEF") | [SP](SP.md "SP") |
| --- | --- | --- | --- |
| 1 | +20 | +15 | 50 |
| 2 | +25 | +30 | 54 |
| 3 | +30 | +45 | 58 |
...
- Os bônus de [ATQ](ATQ.md "ATQ") e [DEF](DEF.md "DEF") são iguais aos dados por equipamentos e são acumulativos.
- Sobre Duetos:
