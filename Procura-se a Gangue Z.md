---
title: "Procura-se a Gangue Z"
source: https://browiki.org/wiki/Procura-se_a_Gangue_Z
namespace: 0
revision: 27939
...
| **Nv. de base** | 70 |
| **Tipo** | Normal |
| **[Itens](Itens.md "Itens")** | 12049.png 5 [Vinho de Frutas de Morroc](http://www.divine-pride.net/database/item/12049/)  7098.png 20 [Lenhas em Brasa](http://www.divine-pride.net/database/item/7098/)  970.png 2 [Álcool](http://www.divine-pride.net/database/item/970/)  7035.png 1 [Palito de Fósforo](http://www.divine-pride.net/database/item/7035/)  7097.png 10 [Coração Incandescente](http://www.divine-pride.net/database/item/7097/) |
| **[Zeny](Zeny.md "Zeny")** | +500 |
| Premiação | |
| **[EXP base](Experiência de Base.md "Experiência de Base")** | 100.000 |
...
5. Desafie Moonho Ahn (payon 244,62)
   ...
   - Cada partida custa 500 [zenys](Zenys.md "Zenys").
   - Seu objetivo é adivinhar as moedas digitando `Par` ou  `ímpar`
   - Você precisa vencer 2 rodadas, no mínimo.
   - Existe um erro na hora de digitar  `ímpar`, você precisa dar um espaço e escrever com letra minúscula.
6. Retorne a Marybell, na Guilda dos Arruaceiros.
...
7. Você deverá encontrar o Homem Suspeito em uma dos dois locais possíveis. Se ele não estiver em um ponto, ele poderá estar no outro.
   ...
   - Na primeira vez, basta se aproximar dele para iniciar o diálogo. Na segunda vez você precisa clicar nele para conversar.
8. Volte a Marybell.
