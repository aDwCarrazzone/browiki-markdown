...
| **Quests anteriores** | [Criança Desaparecida](../Quests/Experi%C3%AAncia/Crian%C3%A7a%20Desaparecida.md "Criança Desaparecida") |
| Premiação | |
| **[EXP base](../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 140.000 |
| **[EXP classe](../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 60.000 |
| **Recompensa** | Acesso ao [Santuário de Rachel](http://www.divine-pride.net/database/map/ra_san01/) |
...
4. Explore o Santuário.
   ...
   - Ande diversas vezes pelos pontos **5** e **6** até que o diálogo se repita.
...
6. Converse com Panno (ra\_temin 170,43)
   ...
   - Selecione:
     ...
     - *O portão do templo estava trancado!*
     - *Explique-se!*
...
7. Entregue 20 [Fogos de Artifício](http://www.divine-pride.net/database/item/12018/) para Nemma.
   ...
   - Você pode comprá-los em uma loja no sul de [Hugel](../Lugares/Hugel.md "Hugel") (hugel 92,104).
   - Após entregar os itens, você receberá 50.000 pontos de [experiência](../Redirecionamentos/Experi%C3%AAncia.md "Experiência").
8. Localize o Sumo Sacerdote Zhed (ra\_temin 276,159)
   ...
   - Se o diálogo de Zhed for "*Que Freya abençoe você.*", significa que você não completou a missão [Criança Desaparecida](../Quests/Experi%C3%AAncia/Crian%C3%A7a%20Desaparecida.md "Criança Desaparecida").
...
14. Neste mapa, basta seguir em linha reta e ouvir os diálogos até seu personagem ser enviado de volta para [Rachel](../Lugares/Rachel.md "Rachel").
...
15. Retorne a Zhed (ra\_temin 276,159)
    ...
    - Você receberá 90.000 de [experiência](../Redirecionamentos/Experi%C3%AAncia.md "Experiência")
...
*Importado da [bROWiki](https://browiki.org/wiki/Santu%C3%A1rio_de_Rachel) — revisão 41640*
