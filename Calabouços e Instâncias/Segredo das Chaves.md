...
| **Recompensa** | Acesso a [Ilha das Tartarugas](http://www.divine-pride.net/database/map/tur_dun01/) |
...
5. Fale com o Barqueiro (alberta 244,118)
   ...
   - Após perguntar sobre a ilha e como chegar nela, ele viajará com você por 10.000 [zenys](../Redirecionamentos/Zenys.md "Zenys").
6. Dirija-se para as coordenadas de acordo com a chave citada no diário.
   ...
   1. Localize a Lápide de Caveira (tur\_dun01 160,80)
      ...
      - Você receberá um dos prêmios aleatórios abaixo:
        ...
        - 5 [Sucos de Banana](http://www.divine-pride.net/database/item/532/)
        - 5 [Bananas](http://www.divine-pride.net/database/item/513/) e 5 [Sucos de Banana](http://www.divine-pride.net/database/item/532/)
   ...
   3. Procure o Pilar da Tartaruga (tur\_dun02 47,156)
      ...
      - Você receberá um dos prêmios aleatórios abaixo:
        ...
        - 1 [Gema Vermelha](http://www.divine-pride.net/database/item/716/)
        - 1 [Moldura Vermelha](http://www.divine-pride.net/database/item/734/)
        - 1 [Cachecol Vermelho](http://www.divine-pride.net/database/item/10019/)
        - 1 [Peridoto](http://www.divine-pride.net/database/item/725/)
   ...
   4. Ache mais uma Pedra de Tartaruga (tur\_dun04 110,175)
      ...
      - Você receberá um dos prêmios aleatórios abaixo:
        ...
        - 1 [Caixa de Presente](http://www.divine-pride.net/database/item/644/)
        - 1 [Velha Caixa Roxa](http://www.divine-pride.net/database/item/617/)
        - 1 [Velho Álbum de Cartas](http://www.divine-pride.net/database/item/616/)

---
*Categorias: Quest, Acesso a Calabouços*  
*Importado da [bROWiki](https://browiki.org/wiki/Segredo_das_Chaves) — revisão 44260*
