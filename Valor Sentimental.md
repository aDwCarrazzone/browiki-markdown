...
source: https://browiki.org/wiki/Valor_Sentimental
namespace: 0
revision: 34561
...
| **[Itens](Itens.md "Itens")** | 6919.png 14 [Marca de Honra](http://www.divine-pride.net/database/item/6919/) |
| **Recompensa** | Libera a missão [Os Wigner](As Famílias Reais.md#Os_Wigner "As Famílias Reais") |
...
3. Você precisa andar pela cozinha para ativar os diálogos.
   ...
   1. **Parede Mofada** (losango): (prt\_cas 339,212)
      - 1 [Água Benta](http://www.divine-pride.net/database/item/523/)
      - 1 [Pó de Bolor](http://www.divine-pride.net/database/item/7001/)
   2. **Parede Grudenta** (triângulo): (prt\_cas 339,198)
      - 1 [Laranja](http://www.divine-pride.net/database/item/582/)
      - 1 [Álcool](http://www.divine-pride.net/database/item/970/)
   3. **Piso Sujo** (círculo): (prt\_cas 309,215)
      - 1 [Limão](http://www.divine-pride.net/database/item/568/)
      - 1 [Areia Fina](http://www.divine-pride.net/database/item/7043/)
4. Reporte a limpeza para a Empregada.
5. Procure pelo Entregador de Móveis (prontera 68,68)

   :   ![Valor S2](images/5/5b/Valor_S2.png)

   - Entregue 3 [Medalhões de Carne](http://www.divine-pride.net/database/item/6254/) para o [NPC](NPC.md "NPC").
6. Converse com Jurgen Wigner, no Palácio (prt\_cas\_q 97,6)
   ...
   - Ao entregar as [Pedras do Mar](http://www.divine-pride.net/database/item/6927/), o [NPC](NPC.md "NPC") remove todas elas do inventário.
7. Entregue os itens a Jurgen Wigner para receber sua recompensa.
   - Você receberá 1.000.0000 de [EXP](EXP.md "EXP") base, 500.000 de [EXP](EXP.md "EXP") base e 10 [Marcas de Honra](http://www.divine-pride.net/database/item/6919/).
...
11. Com os itens no inventário, dirija-se para a Empregada.
    - Ao entregar as [Pedras do Mar](http://www.divine-pride.net/database/item/6927/), a [NPC](NPC.md "NPC") remove todas elas do inventário.
12. Conte o relato a Jurgen Wigner para receber sua recompensa.
    - Você receberá 200.000 de [EXP](EXP.md "EXP") de base, classe e 4 [Marcas de Honra](http://www.divine-pride.net/database/item/6919/).
    - A partir daqui, você já pode fazer a missão [Os Wigner](As Famílias Reais.md#Os_Wigner "As Famílias Reais")
