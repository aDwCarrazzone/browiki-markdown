---
title: "Recital de Geffenia"
source: https://browiki.org/wiki/Recital_de_Geffenia
namespace: 0
revision: 46305
...
|  |  |
| --- | --- |
| **Recital de Geffenia Recital de Geffenia** | |
| [Arquivo:Recital de Geffenia.gif](https://browiki.org/index.php?title=Especial:Carregar_arquivo&wpDestFile=Recital_de_Geffenia.gif "Arquivo:Recital de Geffenia.gif") | |
| **Geffenia Nocturne / Recital de Geffenia** | |
| **ID** | TR\_GEF\_NOCTURN (5358) |
| **Tipo** | Ativa |
| **Níveis** | 5 |
...
| **Ícone** | I Recital de Geffenia |
| **Áudio** | <https://browiki.org/wiki/Arquivo:Recital_de_Geffenia.mp3> |
| **Pré-requisitos** | |
| - [Presença de Palco](Presença de Palco.md "Presença de Palco") [Presença de Palco](Presença de Palco.md "Presença de Palco") Nv. 3 | |

Faz uma apresentação dramática.

Concede uma chance de reduzir parte da [TENM](TENM.md "TENM") de todos os inimigos ao seu redor.

Essa música tem uma *Participação Especial*.

- Reduz ainda mais o valor de [TENM](TENM.md "TENM").
...
Redução de [TENM](TENM.md "TENM"):  
`[(Nv. da habilidade × 10) × Nv. de Presença de Palco)] ÷ 5`

Redução de [TENM](TENM.md "TENM") com Participação Especial:  
...
- A redução de [TENM](TENM.md "TENM") não é cumulativa com [itens](Itens.md "Itens") de efeitos semelhantes.
