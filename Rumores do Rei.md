---
title: "Rumores do Rei"
source: https://browiki.org/wiki/Rumores_do_Rei
namespace: 0
revision: 34706
...
| **[Itens](Itens.md "Itens")** | 2916.png 1 [Asa de Fada](http://www.divine-pride.net/database/item/2916/) |
...
8. Pegue o [Pacote de Correio](http://www.divine-pride.net/database/item/6552/) com o Diretor do Escritório (splendide 267,368)
   ...
   - O [NPC](NPC.md "NPC") fica na parte de cima, o acesso pode ser feito a partir de (splendide 249,244)
   - Você não precisa equipar o Anel do Rei Sábio.
9. Dê o [Pacote de Correio](http://www.divine-pride.net/database/item/6552/) ao Mensageiro Roy.
   - Você receberá 200.000 de experiência de base e classe.
10. Converse com o Guarda de Eclage, Leo. (eclage 111,41)
    ...
    - Esses itens podem ser comprados em [Esplendor](Esplendor.md "Esplendor") usando [Moeda Esplendor](http://www.divine-pride.net/database/item/6081/).
      - As moedas podem ser adquiridas de várias formas, a mais fácil é através da missão diária [Perfume de Alfheim](Aventuras no Novo Mundo.md#Perfume_de_Álfheim "Aventuras no Novo Mundo").
        - Você não precisa completar a missão [Anel do Rei Sábio](Anel do Rei Sábio.md "Anel do Rei Sábio") caso já tenha o anel, basta equipá-lo e falar com a Mercadora de Esplendor (splendide 198,237)
      - Cada moeda compra 3 unidades de geleia.
      - As geleias não podem ser negociadas ou enviadas por [RODEX](RODEX.md "RODEX"), apenas guardadas no [Armazém](Armazém.md "Armazém").
11. Dê as geleias ao Guarda de Eclage, Leo.
    - Você receberá 200.000 de experiência de base e classe.
12. Reencontre o Rei Jun Kardui. Você recebe 200.000 de experiência de base e classe.
