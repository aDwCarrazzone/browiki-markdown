...
- O sistema funciona através da janela de navegação ou pelo [comando](../Sem%20categoria/Comando.md "Comando") `/navi`
- O [comando](../Sem%20categoria/Comando.md "Comando") precisa do nome do mapa, das coordenadas *x* e das coordenadas *y* para inciiar.
...
- Você pode ver as suas coordenadas através do [comando](../Sem%20categoria/Comando.md "Comando") `/where` ou abaixo do mini-mapa na sua direita superior.
...
- Posicionar o mouse em uma cidade mostra as rotas de [teleporte](Servi%C3%A7os.md "Serviços") e [aeroplano](../Sem%20categoria/Aeroplano.md "Aeroplano") para as cidades disponíveis.
...
- Ele exibe a localização do seu personagem no mapa atual, as coordenadas em tempo real e os [NPCs](../Sem%20categoria/NPC.md "NPC") mais importantes.
- Clicar nos ícones de [NPC](../Sem%20categoria/NPC.md "NPC") do mini-mapa ativará a navegação.
...
Esse sistema é muito útil para evitar ficar copiando e colando as coordenadas dos [NPCs](../Sem%20categoria/NPC.md "NPC") a todo momento.
...
| Sistemas | [Conquistas](Conquistas.md "Conquistas") · [RODEX](../Sem%20categoria/RODEX.md "RODEX") · [Replay](Replay.md "Replay") · Navegação · [Lojinha de Rua](Lojinha%20de%20Rua.md "Lojinha de Rua") · [Estilista](Estilista.md "Estilista") · [Combinação](../Itens/Combina%C3%A7%C3%A3o.md "Combinação") · [Grupo](Grupo.md "Grupo") · [Clã](../PvP/Cl%C3%A3.md "Clã") · [Reputação](Reputa%C3%A7%C3%A3o.md "Reputação") |
