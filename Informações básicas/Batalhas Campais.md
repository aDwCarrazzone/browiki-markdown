...
- [Habilidades](../Habilidades%20especiais/Habilidades.md "Habilidades") desabilitadas durante os períodos de [guerra](../PvP/Guerra%20do%20Emperium.md "Guerra do Emperium") também não funcionam nas Batalhas Campais, incluindo [Corrida](../Ativa/Corrida.md "Corrida"), [Salto](../Ativa/Salto.md "Salto") e habilidades Solares, Lunares e Estelares.
...
- [Cartas](../Itens/Cartas.md "Cartas") e [itens](../Itens/Itens.md "Itens") que tornam a [conjuração](../Sem%20categoria/Conjura%C3%A7%C3%A3o.md "Conjuração") ininterruptível não funcionam.
...
- Companheiros do mesmo exército podem ser vistos no minimapa, exibem barra de [HP](../Sem%20categoria/HP.md "HP") como em um [grupo](Grupo.md "Grupo") e podem comunicar-se entre si utilizando o comando `/battlechat`
- Nos mapas, os personagens são considerados:
  ...
  - Tamanho [Médio](../Sem%20categoria/Tamanho.md "Tamanho") (adultos) ou [Pequeno](../Sem%20categoria/Tamanho.md "Tamanho") ([crianças](Fam%C3%ADlia.md#Adoção "Família") e [Doram](../Sem%20categoria/Doram.md "Doram")).

## Premiação

Você pode trocar os Emblemas ou Pontos adquiridos por [itens](../Itens/Itens.md "Itens").

Existem prêmios específicos para cada Emblema e Ponto, isso significa que você não poderá trocar [armas](../Sem%20categoria/Armas.md "Armas") tipo **A**, usando Emblemas de Valor (que só trocam por armas tipo **B**).
...
Algumas [armas](../Sem%20categoria/Armas.md "Armas") do KVM possuem o efeito *Carniceiro*, que aumenta o dano físico contra oponentes das raças [humano](../Sem%20categoria/Humano.md "Humano") e [humanoide](../Sem%20categoria/Humanoide.md "Humanoide").

| [Refino](../Sem%20categoria/Refino.md "Refino") | Nv. 1 | Nv. 2 |
| --- | --- | --- |
| 6 | +4% | +9% |
| 7 | +9% | +16% |
| 8 | +16% | +25% |
