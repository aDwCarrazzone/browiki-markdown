...
Para criar um grupo, é necessário ter as habilidades [Instintos Básicos](../Passiva/Instintos%20B%C3%A1sicos.md "Instintos Básicos") nível 1 ou [Habilidades Básicas](../Passiva/Habilidades%20B%C3%A1sicas.md "Habilidades Básicas") em nível 7.
...
- Você verá a barra de [HP](../Sem%20categoria/HP.md "HP") de outros membros do seu grupo.
- Se todos os membros do seu grupo estiverem offline e você for o líder e sair do grupo, o grupo será desfeito.
- Você não pode mudar a liderança do grupo para um membro que esteja fora do mapa ou dentro de uma [instância](../Sem%20categoria/Inst%C3%A2ncia.md "Instância").
...
| Divisão da EXP | Qualquer membro que derrotar qualquer [monstro](../Sem%20categoria/Monstro.md "Monstro") no mesmo mapa, a [experiência](../Sem%20categoria/Experi%C3%AAncia.md "Experiência") de base e classe será dividida para todos. |
| Delegação de grupo | Aparece ao clicar com o botão direito no nome do membro do grupo, permitindo transferir a liderança somente se estiver no mesmo mapa que você. Não funciona dentro de [instâncias](../Quest/Inst%C3%A2ncias.md "Instâncias"). |
| Usar habilidades | É possível usar habilidades como [Curar](../Suporte/Curar.md "Curar") e [Bênção](../Suporte/B%C3%AAn%C3%A7%C3%A3o.md "Bênção") pela mini-janela de grupo, selecionando no nome do personagem. |
...
| Enviar RODEX | Abre a janela de [RODEX](../Sem%20categoria/RODEX.md "RODEX") com o nome do membro do grupo selecionado. |
...
Ao dividir a [experiência](../Sem%20categoria/Experi%C3%AAncia.md "Experiência"), haverá um bônus de [EXP](../Sem%20categoria/EXP.md "EXP") por membro do grupo.

Só é possível realizar a divisão se os membros estiverem dentro de 15 níveis de base um do outro, ou seja: um personagem nível 100 não poderá dividir a [experiência](../Sem%20categoria/Experi%C3%AAncia.md "Experiência") com outro de nível 116.

Membros da [família](Fam%C3%ADlia.md "Família") não podem mais dividir a [EXP](../Sem%20categoria/EXP.md "EXP") independente do nível, é preciso que todos os três estejam com 15 níveis de diferença entre eles.

| Membros | [EXP](../Sem%20categoria/EXP.md "EXP") total | [EXP](../Sem%20categoria/EXP.md "EXP") por membro |
| --- | --- | --- |
| 2 | 120% | 60% |
| 3 | 140% | 47% |
| 4 | 160% | 40% |
...
| Sistemas | [Conquistas](Conquistas.md "Conquistas") · [RODEX](../Sem%20categoria/RODEX.md "RODEX") · [Replay](Replay.md "Replay") · [Navegação](Navega%C3%A7%C3%A3o.md "Navegação") · [Lojinha de Rua](Lojinha%20de%20Rua.md "Lojinha de Rua") · [Estilista](Estilista.md "Estilista") · [Combinação](../Itens/Combina%C3%A7%C3%A3o.md "Combinação") · Grupo · [Clã](../PvP/Cl%C3%A3.md "Clã") · [Reputação](Reputa%C3%A7%C3%A3o.md "Reputação") |
