...
- A cada 1 ponto:
  - [ATQ](../Sem%20categoria/ATQ.md "ATQ") de atributo +5.
  - Duração de [Letargia](../Sem%20categoria/Letargia.md "Letargia") -0,08 segundos.
- A cada 3 pontos:
  - [P.ATQ](../Sem%20categoria/P.ATQ.md "P.ATQ") +1.
...
- A cada 1 ponto:
  - [TEN](../Sem%20categoria/TEN.md "TEN") +1.
  - Duração de [Escuridão](../Sem%20categoria/Escurid%C3%A3o.md "Escuridão") e [Intoxicação](../Sem%20categoria/Intoxica%C3%A7%C3%A3o.md "Intoxicação") -0,08 segundos.
- A cada 3 pontos:
  - [TEN](../Sem%20categoria/TEN.md "TEN") +5.
...
- A cada 1 ponto:
  - [TENM](../Sem%20categoria/TENM.md "TENM") +1.
  - Duração de [Tristeza](../Sem%20categoria/Tristeza.md "Tristeza") e [Eletrificação](../Sem%20categoria/Eletrifica%C3%A7%C3%A3o.md "Eletrificação") -0,08 segundos.
- A cada 3 pontos:
  - [TENM](../Sem%20categoria/TENM.md "TENM") +5.
...
- A cada 1 ponto:
  - [ATQM](../Sem%20categoria/ATQM.md "ATQM") +5.
  - Duração de [Quietude](../Sem%20categoria/Quietude.md "Quietude") e [Ardência](../Sem%20categoria/Ard%C3%AAncia.md "Ardência") -0,08 segundos.
- A cada 3 pontos:
  - [S.ATQM](../Sem%20categoria/S.ATQM.md "S.ATQM") +1.
...
- A cada 1 ponto:
  - [Esquiva](../Sem%20categoria/Esquiva.md "Esquiva") +2.
  - [Precisão](../Desambigua%C3%A7%C3%A3o/Precis%C3%A3o.md "Precisão") +2.
- A cada 5 pontos:
  - [P.ATQ](../Sem%20categoria/P.ATQ.md "P.ATQ") +1.
  - [S.ATQM](../Sem%20categoria/S.ATQM.md "S.ATQM") +1.
...
- A cada 1 ponto:
  - [C.Mais](../Sem%20categoria/C.Mais.md "C.Mais") +1.
  - [Precisão](../Desambigua%C3%A7%C3%A3o/Precis%C3%A3o.md "Precisão") +2.
  - Duração de [Concretação](../Sem%20categoria/Concreta%C3%A7%C3%A3o.md "Concretação"), [Azar](../Sem%20categoria/Azar.md "Azar") e [Esfriamento](../Sem%20categoria/Esfriamento.md "Esfriamento") -0,08 segundos.
  - Aumenta a chance de criação de [Manipular Poção](../Ativa/Manipular%20Po%C3%A7%C3%A3o.md "Manipular Poção") e [Criar Máquina](../Ativa/Criar%20M%C3%A1quina.md "Criar Máquina").
  - Influencia nas chances de [Remoção Sombria Total](../Ativa/Remo%C3%A7%C3%A3o%20Sombria%20Total.md "Remoção Sombria Total").

## Talentos Secundários

### Poder de Ataque

Diferente do [ATQ](../Sem%20categoria/ATQ.md "ATQ"), o Poder de Ataque (**P.ATQ**) afeta diretamente o dano físico causado.
...
Antes de calcular a [Defesa Física](../Sem%20categoria/DEF.md "DEF"), a Tenacidade (**TEN**) reduz o dano físico normal recebido em valores porcentuais (%).
...
Antes de calcular a [Defesa Mágica](../Sem%20categoria/DEFM.md "DEFM"), a Tenacidade Mágica (**TENM**) reduz o dano mágico normal recebido em valores porcentuais (%).
...
- Exemplo:
  - Você usa uma [habilidade](../Sem%20categoria/Habilidade.md "Habilidade") de regeneração, que cura 20.000 de [HP](../Sem%20categoria/HP.md "HP").
  - Se você possuir 20 de C.Mais, cura 24.000 de [HP](../Sem%20categoria/HP.md "HP")
  - Ou seja, aumentou em 20% o valor da cura.

A cada 100 pontos, aumenta a área de efeito da habilidade [Mediale Votum](../Suporte/Mediale%20Votum.md "Mediale Votum").
...
Esse efeito não está relacionado ao aumento de *dano crítico* dos [itens](../Itens/Itens.md "Itens")/[equipamentos](../Sem%20categoria/Equipamentos.md "Equipamentos"), é uma nova variável.
...
| Personagens | [Classes](Classes.md "Classes") (*[Builds](Guias%20de%20Classe.md "Guias de Classe")*) · [Nível](N%C3%ADvel.md "Nível") · [Drop](N%C3%ADvel.md#Drop "Nível") · [Experiência](N%C3%ADvel.md#Experiência "Nível") · [Atributos](Atributos.md "Atributos") / Talentos · [Habilidades](../Habilidades%20especiais/Habilidades.md "Habilidades") · [Família](Fam%C3%ADlia.md "Família") · [RolePlay](RolePlay.md "RolePlay") |
