...
- Selecione a opção "*Mudar meu estilo*" para abrir a Loja de Estilos.
  - Você pode selecionar os cortes e cores de cabelo, mas alguns cortes dependem de [zenys](../Sem%20categoria/Zeny.md "Zeny") e de cupons.
  - Para mudar a cor da roupa, você precisa do Cupom comprado via [JoyCoins](../Itens/JoyCoins.md "JoyCoins").
  - Para mudar de roupa, clique no botão "Roupa Alternativa", disponível somente para Classes 3.

## Cabelos

- Os cabelos de 1 a 23 custam apenas 100.000 [zenys](../Sem%20categoria/Zenys.md "Zenys") pela mudança.
- Mudar a cor do cabelo custa 100.000 [zenys](../Sem%20categoria/Zenys.md "Zenys").
  - Existe uma [NPC](../Sem%20categoria/NPC.md "NPC") Cabeleireira ao lado de todo Estilista que cobra mais barato, apenas levar umas [Tinturas](../Sem%20categoria/Tinturas.md "Tinturas") e 1.000 [zenys](../Sem%20categoria/Zenys.md "Zenys").
...
| Sistemas | [Conquistas](Conquistas.md "Conquistas") · [RODEX](../Sem%20categoria/RODEX.md "RODEX") · [Replay](Replay.md "Replay") · [Navegação](Navega%C3%A7%C3%A3o.md "Navegação") · [Lojinha de Rua](Lojinha%20de%20Rua.md "Lojinha de Rua") · Estilista · [Combinação](../Itens/Combina%C3%A7%C3%A3o.md "Combinação") · [Grupo](Grupo.md "Grupo") · [Clã](../PvP/Cl%C3%A3.md "Clã") · [Reputação](Reputa%C3%A7%C3%A3o.md "Reputação") |
