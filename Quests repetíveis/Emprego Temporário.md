...
1. A missão inicia após um anúncio em [broadcast](../Sem%20categoria/Broadcast.md "Broadcast") no [Acampamento da Expedição da Aliança](http://www.divine-pride.net/database/map/mid_camp/):
   - `Atenção, aventureiros no campo!`
   - `Estou recrutando 5 temporários para minha fazenda de criação.`
