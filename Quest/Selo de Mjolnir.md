...
3. A [NPC](../Sem%20categoria/NPC.md "NPC") dirá a ordem necessária para visitar os anões, mas tenha em mente:
   ...
   - Se irritar algum dos anões, converse novamente com Tialfi e depois com Roskva.
...
5. Anão do Sul (mjolnir\_09 209,341)
   ...
   - Dicas:
     - Comece acertando a cabeça dele e depois selecionando a opção "contra-atacar". Se der certo, continue usando "cabeça" e depois "esquivar" até vencer a batalha.
...
7. Anão do Norte (mjolnir\_12 18,18)
   ...
   - Existem dois tipos de respostas, observe pelas opções do diálogo qual é a correta:
     ...
     - Questionário 2
       ...
       - Pensamentos
       - Idade
8. Volte ao Tialfi com 50 [Minérios de Elunium](http://www.divine-pride.net/database/item/757/) e [Minérios de Oridecon](http://www.divine-pride.net/database/item/756/) para receber sua recompensa.
   - Se você selecionar a opção "*Pegar arma que eu possa usar*", você receberá uma arma de acordo com a sua [classe](../Sem%20categoria/Classe.md "Classe"). Veja a lista abaixo.
   - Se você escolher a opção "*Pegar arma para um amigo*", você receberá uma arma da lista abaixo, de maneira aleatória.
