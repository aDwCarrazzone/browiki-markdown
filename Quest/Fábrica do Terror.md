...
5. Assim que aparecer, clique na Caixa de Uniformes ao lado da [NPC](../Sem%20categoria/NPC.md "NPC") para se transformar em um Cookie.
   ...
   - Informações:
     ...
     - A duração do disfarce é de 3 minutos, mas você pode clicar nas Caixas de Uniformes espalhadas na fase para reiniciar a contagem desse tempo.
     - Se algum personagem morrer e for ressuscitado, o disfarce é cancelado e os [Soldadinhos Corrompidos](http://www.divine-pride.net/database/monster/2990/) surgirão.
...
10. Clique na Caixa de Uniformes para transformar-se em Cookie novamente.
    ...
    - Informações:
      ...
      - Nesta fase, aparecerão [Lude Grotesco](http://www.divine-pride.net/database/monster/2992/), [Ursinho Abominável](http://www.divine-pride.net/database/monster/2995/), [Presente das Trevas](http://www.divine-pride.net/database/monster/2991/) e [Poltergeist Sangrento](http://www.divine-pride.net/database/monster/2993/)
...
14. Após o diálogo, dirija-se ao portal da esquerda.
    - Informações:
      ...
      - Nesta fase, aparecerão [Lude Grotesco](http://www.divine-pride.net/database/monster/2992/), [Ursinho Abominável](http://www.divine-pride.net/database/monster/2995/), [Marionete Demoníaca](http://www.divine-pride.net/database/monster/2994/), [Poltergeist Sangrento](http://www.divine-pride.net/database/monster/2993/) e [Árvore Maldita Decorada](http://www.divine-pride.net/database/monster/2987/).
15. Retorne ao local onde estava o Papai Noel Capturado e entre no portal da direita para seguir a próxima etapa.
...
17. Assim que a conversa terminar, [Celine Kimi](http://www.divine-pride.net/database/monster/2996/) atacará seu [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo"), preste atenção nas dicas:
    ...
    - Se não houver jogadores para atacar, as duas continuarão usando [Curar](../Suporte/Curar.md "Curar").
    - Caso a [MVP](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/MVP.md "MVP") se afaste do seu local de nascimento, ela reiniciará a fase com o [HP](../Sem%20categoria/HP.md "HP") totalmente recuperado.
