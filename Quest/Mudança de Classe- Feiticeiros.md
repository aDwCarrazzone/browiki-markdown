# Mudança de Classe: Feiticeiros

# Mudança de Classe: Feiticeiros

| ![JQ ico](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/2/22/JQ_ico.png) Mudança de Classe: Feiticeiros | |
| --- | --- |
| Requisitos mínimos | |
| **Nv. de base** | 99 |
| **Nv. de classe** | 70 |
| **Tipo** | Classe |
| **Classe** | [Professor](../Sem%20categoria/Professor.md "Professor") |
| **[Itens](../Itens/Itens.md "Itens")** | ![992.png](https://static.divine-pride.net/images/items/item/992.png) 3+ [Frescor do Vento](http://www.divine-pride.net/database/item/992/) ![991.png](https://static.divine-pride.net/images/items/item/991.png) 3+ [Cristal Azul](http://www.divine-pride.net/database/item/991/)  ![990.png](https://static.divine-pride.net/images/items/item/990.png) 3+ [Sangue Escarlate](http://www.divine-pride.net/database/item/990/)  ![993.png](https://static.divine-pride.net/images/items/item/993.png) 3+ [Vida Verdejante](http://www.divine-pride.net/database/item/993/) |
| Premiação | |
| **[Itens](../Itens/Itens.md "Itens")** | ![2795.png](https://static.divine-pride.net/images/items/item/2795.png) 1 [Anel de Maçã Verde](http://www.divine-pride.net/database/item/2795/)  ![5756.png](https://static.divine-pride.net/images/items/item/5756.png) 1 [Sussurro dos Elementos](http://www.divine-pride.net/database/item/5756/) |
| **Recompensa** | Muda a classe para [Feiticeiro](../Sem%20categoria/Feiticeiro.md "Feiticeiro") |
...
1. Encontre Merito (gef\_tower 102,34)
   ...
   - Selecione:
     - Você conhece os Feiticeiros?
     - Qualquer opção, exceto *Espírito da Carne*
     - Escrever nome
   - Clique novamente no [NPC](../Sem%20categoria/NPC.md "NPC").
     - Sim, eu consigo
     - Eles podem lidar com espíritos
     - Vou fazer o teste
2. Com os itens no inventário, fale com Karacas (gef\_tower 113,161)
   ...
   - 3 [Sangue Escarlate](http://www.divine-pride.net/database/item/990/)
   - 3 [Vida Verdejante](http://www.divine-pride.net/database/item/993/)
3. Seu teste é coletar 1 [Reagente Puro](http://www.divine-pride.net/database/item/6276/), 1 [Reagente Vermelho](http://www.divine-pride.net/database/item/6277/) e 1 [Reagente Preto](http://www.divine-pride.net/database/item/6278/) dos Espíritos Detectores.
   - Cada Espírito Detector consome 3 pedras de um elemento específico para te dar um reagente, mas existem chances de falha e perda das 3 pedras.
   - Recomenda-se levar cerca de 60 a 100 pedras de cada elemento.
   - Ao falar com um Espírito, uma conjuração de 5 segundos aparece, podendo ser cancelada se você receber um ataque.
   - Não precisa seguir uma ordem ou falar com todos, basta conseguir o reagente necessário, podendo ser nos mapas menos agressivos.
   - É possível coletar 2 reagentes diferentes em cada Espírito Detector, quantas vezes for necessário.
...
4. Entregue os reagentes a Karacas para mudar de classe e receber 1 [Anel de Maçã Verde](http://www.divine-pride.net/database/item/2795/) e 1 [Sussurro dos Elementos](http://www.divine-pride.net/database/item/5756/) [1].
...
| [Quests](Quests.md "Quests") | [Mudança de Classe: Sábios](Mudan%C3%A7a%20de%20Classe-%20S%C3%A1bios.md "Mudança de Classe: Sábios") · Mudança de Classe: Feiticeiros · [Mudança de Classe: Elementalistas](../Quests%20de%20ca%C3%A7a/Mudan%C3%A7a%20de%20Classe-%20Elementalistas.md "Mudança de Classe: Elementalistas") [Novas habilidades](Novas%20habilidades-%20Magos%20e%20evolu%C3%A7%C3%B5es.md "Novas habilidades: Magos e evoluções") | |
