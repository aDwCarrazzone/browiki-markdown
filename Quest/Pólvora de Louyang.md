...
2. A próxima etapa requer adicionar 8 pessoas em seu grupo, para isso dar certo, faça o seguinte:
   ...
   - Repita esse procedimento até que 8 pessoas estejam no seu [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo").
     - Não adicione as 8 pessoas de uma vez.
3. Ao realizar o procedimento corretamente, você receberá 8 [Montes de Lama](http://www.divine-pride.net/database/item/7004/), 8 [Madeiras Queimadas](http://www.divine-pride.net/database/item/7068/) e 8 [Pedras Pome](http://www.divine-pride.net/database/item/7096/).
   - Coloque os itens no [carrinho](../Passiva/Usar%20Carrinho.md "Usar Carrinho") de algum membro do seu [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo").
...
7. Retornem ao lugar da Pessoa Escondida, o líder do [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo") deve entregar as 8 [Pólvoras](http://www.divine-pride.net/database/item/7204/) para o [NPC](../Sem%20categoria/NPC.md "NPC").
8. Como recompensa, o líder receberá 8 [Envelopes Vermelhos](http://www.divine-pride.net/database/item/668/), que devem ser distribuídos para os membros do [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo").
   - Cada [Envelope Vermelho](http://www.divine-pride.net/database/item/668/) oferece uma quantia aleatória de [zeny](../Sem%20categoria/Zeny.md "Zeny"), entre 1.000 a 10.000.
