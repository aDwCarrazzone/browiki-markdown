...
4. Eliminando todos os [Vermes com Rosto](http://www.divine-pride.net/database/monster/2528/), um [Verme Sombrio](http://www.divine-pride.net/database/monster/2530/) aparece.
   - Ele pode invocar [Ovos de Verme](http://www.divine-pride.net/database/monster/2540/), que regeneraram [HP](../Sem%20categoria/HP.md "HP") do monstro.
...
5. Após eliminar o [Verme Sombrio](http://www.divine-pride.net/database/monster/2530/), um baú aparece.
   ...
   - Apenas o líder do [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo") pode abrir os baús.
6. Repita os mesmos passos em todas as fases.
   - Na **3ª** fase, fuja dos [Casulos](http://www.divine-pride.net/database/monster/2531/), eles usam [explodir](../Habilidades%20de%20monstros/Explodir.md "Explodir").
...
8. Informações da batalha:
   ...
   - Cada área da [instância](../Sem%20categoria/Inst%C3%A2ncia.md "Instância") tem um tempo contado separadamente, mas o único tempo contado para o record é quando você inicia a história dentro da área da [MVP](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/MVP.md "MVP").
