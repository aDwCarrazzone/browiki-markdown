...
5. Aguarde o final do diálogo e dirija-se ao setor 1 para eliminar todos os monstros.
   - Os [monstros](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Monstros.md "Monstros") são: [Zumbi Amaldiçoado](http://www.divine-pride.net/database/monster/2464/), [Carniçal Amaldiçoado](http://www.divine-pride.net/database/monster/2466/) e [Alma Amaldiçoada](http://www.divine-pride.net/database/monster/2465/).
...
13. Elimine todos os monstros até aparecer *uma mensagem no topo da tela*.
    - Os [monstros](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Monstros.md "Monstros") são: [Khalitzburg Amaldiçoada](http://www.divine-pride.net/database/monster/2471/), [Amaldiçoado do Abismo](http://www.divine-pride.net/database/monster/2470/), [Sanguinário Amaldiçoado](http://www.divine-pride.net/database/monster/2472/), [Arqueiro Amaldiçoado](http://www.divine-pride.net/database/monster/2469/) e [Raydric Amaldiçoado](http://www.divine-pride.net/database/monster/2468/).
...
16. Retorne ao corredor e entre no portal ao norte, siga reto até reencontrar Himmelmez.
    ...
    - Sempre que se aproximar do Fantasma de Varmunt, você receberá um bônus aleatório, temporariamente:
      ...
      :   ![OGH012a](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/c/c1/OGH012a.png)
          ...
          :   **Defesa Temporal**: Resistência ao monstro [Amdarais](http://www.divine-pride.net/database/monster/2476/) +100%.
          :   **Escudo Temporal**: Resistência as barreiras de fogo do [Amdarais](http://www.divine-pride.net/database/monster/2476/) +90%.
...
17. Ao terminar a batalha, todos os membros do [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo") deverão falar com Hugin.
    ...
    - Se esta for sua primeira vez, você receberá:
      ...
      - 5 [Manas Coaguladas](http://www.divine-pride.net/database/item/6608/)
    - Nas outras vezes, você receberá apenas:
      - 1 [Cristal do Tempo](http://www.divine-pride.net/database/item/6607/)
      - 1 [Mana Coagulada](http://www.divine-pride.net/database/item/6608/)
    - O [MVP](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/MVP.md "MVP") é contado na janela de quests e todos do [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo") precisam estar vivos e na mesma tela para contabilizar e poder ganhar a premiação.
