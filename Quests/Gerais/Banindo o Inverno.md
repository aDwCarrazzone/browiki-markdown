...
| **Quests anteriores** | [Encontrando a Ilha-Baleia](../Experi%C3%AAncia/Encontrando%20a%20Ilha-Baleia.md "Encontrando a Ilha-Baleia") |
| Premiação | |
...
3. Retorne para a Bruxa Baba-Yaga, que dará uma missão: Seu objetivo é falar com os [NPCs](../../Redirecionamentos/NPC.md "NPC") abaixo até conseguir que eles digam algo semelhante a "*Inverno, não venha*".
...
11. Clique no Caldeirão para começar a preparar a magia.
    ...
    - Coloque, em ordem:
      - Asas de Morcego Vermelho → Pernas de Gafanhoto → Ovas de Sapo
    - Adicione Água e mexa 20 vezes.
    - Selecione:
      - "*Inserir Ingredientes*"
    - Coloque, em ordem:
      - Areia Estelar de Bruxa → Torrão de Areia Fina
    - Mexa 15 vezes.
    - Selecione:
      - "*Inserir Ingredientes*"
    - Coloque, em ordem:
      - Sangue Escarlate → Neurônio → Coração Incandescente → Diamante
12. Fale com Baba-Yaga até receber o [Remédio de Baba-Yaga](http://www.divine-pride.net/database/item/7765/).
13. Quebre a garrafa no centro de [Moscóvia](../../Lugares/Mosc%C3%B3via.md "Moscóvia") (moscovia 224,190)
...
---
*Categorias: Quest*  
*Importado da [bROWiki](https://browiki.org/wiki/Banindo_o_Inverno) — revisão 27943*
