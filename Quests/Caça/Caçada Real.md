...
2. Aceite a missão da Comandante Nadezda (prt\_fild01 98,171)
   ...
   - Sua missão é eliminar 30 [monstros](../../Sistema%20e%20Mec%C3%A2nicas/Monstros.md "Monstros") da raça [Bruto](../../Redirecionamentos/Bruto.md "Bruto") de qualquer nível.
...
3. Nadezda recomendará que você fale com o Tenente Lofinche.
   ...
   - Seu objetivo é eliminar 30 [monstros](../../Sistema%20e%20Mec%C3%A2nicas/Monstros.md "Monstros") da raça [Bruto](../../Redirecionamentos/Bruto.md "Bruto") e 30 da raça [Inseto](../../Redirecionamentos/Inseto.md "Inseto"), mas só serão contados aqueles de nível 50 ou maior.
   - Os [monstros](../../Sistema%20e%20Mec%C3%A2nicas/Monstros.md "Monstros") que estão no mapa já são o suficiente para completar a missão.
...
4. Lofinche recomendará que você fale com a General Jang.
   ...
   - Ela pedirá que você elimine 30 [monstros](../../Sistema%20e%20Mec%C3%A2nicas/Monstros.md "Monstros") da raça [Peixe](../../Redirecionamentos/Peixe.md "Peixe") e 30 da raça [Dragão](../../Redirecionamentos/Drag%C3%A3o.md "Dragão") que sejam de nível 50 ou maior.
   ...
   - Agora você já pode usar o teleportador para o Campo de Caça.
   - Agora seu personagem pode fazer as missões diárias do Tenente Lofinche.
...
| Missão | Objetivo |
| --- | --- |
| ![DQ ico](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/8b/DQ_ico.png) Caçada: Brutos | Caçar 30 [Brutos](../../Redirecionamentos/Bruto.md "Bruto") de nv.50+ |
| ![DQ ico](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/8b/DQ_ico.png) Caçada: Insetos | Caçar 30 [Insetos](../../Redirecionamentos/Inseto.md "Inseto") de nv.50+ |
| ![DQ ico](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/8b/DQ_ico.png) Caçada: Peixes | Caçar 30 [Peixes](../../Redirecionamentos/Peixe.md "Peixe") de nv.50+ |
| ![DQ ico](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/8b/DQ_ico.png) Caçada: Dragões | Caçar 30 [Dragões](../../Redirecionamentos/Drag%C3%A3o.md "Dragão") de nv.50+ |
...
- O Campo de Caça possui os seguintes monstros:
  - [Planta Carnívora Murcha](http://www.divine-pride.net/database/monster/20067/)
  - [Louva-a-deus Bravo](http://www.divine-pride.net/database/monster/20068/)
  - [Grizzly Atroz](http://www.divine-pride.net/database/monster/20069/)
- Existem Chefes no mapa que só aparecem depois de eliminarem uma quantidade de monstros no mapa.
- Os monstros chefes serão anunciados no mapa quando invocados, eles são:
  - [Bafomé Jr. Cruel](http://www.divine-pride.net/database/monster/20062/)
  - [Lobo Selvagem](http://www.divine-pride.net/database/monster/20063/) *(Não recebe danos físicos)*
  - [Eclipse Bárbaro](http://www.divine-pride.net/database/monster/20064/)
  - [Vocal Cruel](http://www.divine-pride.net/database/monster/20065/) *(Não recebe danos físicos)*
  - [Ungoliant Violento](http://www.divine-pride.net/database/monster/20066/)
  - **[Bafomé Voraz](http://www.divine-pride.net/database/monster/20061/)**

## Recompensas

- Você troca a [Rosa-de-Voto](http://www.divine-pride.net/database/item/23533/) por 90 minutos de efeitos positivos com a General Jang.

| Bônus | Descrição |
| --- | --- |
| Poder de Caça | ATQ da arma + 7%. |
| Sabedoria de Caça | Dano mágico + 7%. |
| Rapidez de Caça | Conjuração variável -7%. Velocidade de ataque +7%. Resistência a oponentes de propriedade Fogo +7%. |

### Tentando a sorte

- Ao tentar a sorte com a General Jang, você poderá receber os seguintes prêmios, de maneira aleatória.
...
| [Anomalia Dimensional](../Gerais/Anomalia%20Dimensional.md "Anomalia Dimensional") | Caçada Real | [Carnaval](../Gerais/Carnaval.md "Carnaval") | [Festival das Mascotes](Festival%20das%20Mascotes.md "Festival das Mascotes") | [Feira do Melão](Feira%20do%20Mel%C3%A3o.md "Feira do Melão") | [Chocomania](Chocomania.md "Chocomania") |
...
*Importado da [bROWiki](https://browiki.org/wiki/Ca%C3%A7ada_Real) — revisão 42699*
