...
| **Quests anteriores** | [O Mensageiro](../Experi%C3%AAncia/O%20Mensageiro.md "O Mensageiro") |
| Premiação | |
...
3. Aproxime-se do Forasteiro.
   ...
   - O [NPC](../../Redirecionamentos/NPC.md "NPC") pode estar em duas localizações diferentes:
     - (nyd\_dun02 144,102)
     - (nyd\_dun02 205,114)
   - Ao aproximar-se do Forasteiro em uma localização, ele reaparecerá em forma de [Dandelion Fugitivo](http://www.divine-pride.net/database/monster/2026/) na outra localização.
...
*Importado da [bROWiki](https://browiki.org/wiki/Pedido_de_Lin) — revisão 40127*
