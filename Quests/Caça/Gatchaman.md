...
2. Após aceitar ajudá-lo, siga pela navegação conversando com os [NPCs](../../Redirecionamentos/NPC.md "NPC") indicados.
3. Seguindo a conversa até o sul de [Morroc](../../Lugares/Morroc.md "Morroc"), aproxime-se de Galaring.
...
5. A [navegação](../../Sistema%20e%20Mec%C3%A2nicas/Navega%C3%A7%C3%A3o.md "Navegação") levará seu personagem até a Fenda Anômala (morocc 23,188)

   :   ![Gatchaman04](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/0/01/Gatchaman04.png)
6. Prepare-se para a [instância](../../Redirecionamentos/Inst%C3%A2ncia.md "Instância")!
   ...
   4. Elimine o [Galaring Bestial](http://www.divine-pride.net/database/monster/22677/) para encerrar a [instância](../../Redirecionamentos/Inst%C3%A2ncia.md "Instância").
7. Retorne para a Fenda Anômala (morocc 23,188) e converse com os [NPCs](../../Redirecionamentos/NPC.md "NPC").
...
- Monstros estão disponíveis somente no mapa [moc\_fild12](http://www.divine-pride.net/database/map/moc_fild12/).
- [Galaring Bestial](http://www.divine-pride.net/database/monster/22677/) está disponível somente na [instância](../../Redirecionamentos/Inst%C3%A2ncia.md "Instância") dele.
...
- As recompensas podem ser resgatadas no [NPC](../../Redirecionamentos/NPC.md "NPC") Armazém.
...
*Importado da [bROWiki](https://browiki.org/wiki/Gatchaman) — revisão 47162*
