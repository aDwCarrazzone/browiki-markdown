...
| --- | --- |
| Ajude membros de um pelotão que se separou anos atrás. --------- ATENÇÃO! Se você não conseguir iniciar ou continuar esta missão, significa que o Selo de Megingjard já foi liberado. Consulte o status dos [Selos Divinos](../Gerais/Selos%20Divinos.md "Selos Divinos") para mais informações. | |
| Requisitos mínimos | |
| **Nv. de base** | 60 |
| **Tipo** | Normal |
...
1. Fale mais de uma vez com Rebarev Doug (prt\_cas 178,243)
   ...
   - Selecione as opções:
     - O que é?
     - Claro, porque não?
     - Estou de saída. (*insista nesta opção até aparecer a opção abaixo*)
     - O que você quis dizer com última missão?
...
2. Com um [Lampião](http://www.divine-pride.net/database/item/1041/) e uma [Lupa](http://www.divine-pride.net/database/item/611/) em mãos, vá ao Bibliotecário (prontera 120,266)
   ...
   - Selecione as opções:
     ...
     - Digite `Os registros dos membros da 3a companhia`
     - Deixe-me ajudar a achar esses arquivos...
...
5. Novamente com o Bibliotecário, procure palavras no documento digitando:
   ...
   - `A 3a companhia o 1o pelotão a 3a esquadra última missão`
...
7. Siga para a estalagem de [Morroc](../../Lugares/Morroc.md "Morroc") e procure pela Funcionária (morocc\_in 146,179)
   ...
   - Existe uma chance desta [NPC](../../Redirecionamentos/NPC.md "NPC") te matar, caso isso aconteça, simplesmente volte e fale com ela novamente.
8. Traga um [Boneco de Poring](http://www.divine-pride.net/database/item/741/) e encontre o Homem Suspeito (in\_rogue 243,61)
   ...
   - Preste atenção neste passo, é importante:
     - Pergunte como ele está e depois pergunte sobre a empregada da estalagem.
     - Após perguntar sobre a missão do esquadrão, haverá uma chance de aparecer a palavra Megingjard no texto.
     - Se isso acontecer, selecione a última opção escondida (de cor branca): *Ouvi-lo tranquilamente*.
...
11. No Bar dos Solteiros em [Jawaii](../../Lugares/Jawaii.md "Jawaii"), converse com Nineball (jawaii\_in 44,110)
    ...
    - Personagens [casados](../../Redirecionamentos/Casamento.md "Casamento") podem acessar [Jawaii](../../Lugares/Jawaii.md "Jawaii") pelo porto de [Izlude](../../Lugares/Izlude.md "Izlude") ou [Lasagna](../../Lugares/Lasagna.md "Lasagna").
    - Para os personagens solteiros chegarem em [Jawaii](../../Lugares/Jawaii.md "Jawaii"), deverão beber com um Cliente chamado João Só (prt\_in 173,13)

    :   :   ![Selo de Megingjard09b](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/6/68/Selo_de_Megingjard09b.png)
12. Com 7 unidades de [álcool](http://www.divine-pride.net/database/item/970/), vá até o Cassino de [Comodo](../../Lugares/Comodo.md "Comodo") e fale com o Homem (cmd\_in02 190,94)

    :   ![Selo de Megingjard11](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/a/a7/Selo_de_Megingjard11.png)

    - Selecione:
      - Sobre Rebarev Doug
      - Discutir Hobbys (Repita 7 vezes até consumir todo os [álcoois](http://www.divine-pride.net/database/item/970/).)
    - Após isso, fale com ele novamente, escolhendo todas as opções.
    - Pode ser que este [NPC](../../Redirecionamentos/NPC.md "NPC") não interaja. Para resolver, volte a falar com o Templário em Geffen.
...
17. Volte a falar com Egnigem para receber sua recompensa em [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência").
18. Fale pela última vez com a Lady de [Al De Baran](../../Lugares/Al%20De%20Baran.md "Al De Baran"). Você ganhará 1 [Velha Caixa Azul](http://www.divine-pride.net/database/item/603/) e a mesma quantidade de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") concedida por Egnigem:

:   :   | [Nível](../../Sistema%20e%20Mec%C3%A2nicas/N%C3%ADvel.md "Nível") | [Experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") |
        | --- | --- |
        | 60 | 3.000 |
        | 61 - 65 | 5.605 |
        | 66 - 70 | 8.223 |
...
*Importado da [bROWiki](https://browiki.org/wiki/Selo_de_Megingjard) — revisão 27799*
