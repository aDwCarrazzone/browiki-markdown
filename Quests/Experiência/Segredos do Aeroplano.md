...
| **[EXP classe](../../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 41.000 |
...
1. No [aeroplano](../../Redirecionamentos/Aeroplano.md "Aeroplano") doméstico, fale mais de uma vez com Hoi (airplane 236,63)
...
4. No [aeroplano](../../Redirecionamentos/Aeroplano.md "Aeroplano") internacional, converse com o Capitão Tarlock (airplane\_01 238,154)
...
5. No [aeroplano](../../Redirecionamentos/Aeroplano.md "Aeroplano") doméstico, entregue 2 [Frutas Espinhosas](http://www.divine-pride.net/database/item/576/) e 2 [Desejos das Trevas](http://www.divine-pride.net/database/item/7340/) ao Capitão Ferlock (airplane 236,163)

   :   ![SdA04](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/9/94/SdA04.png)
6. Reencontre o Capitão Tarlock e entregue a carta. Fique apressando o [NPC](../../Redirecionamentos/NPC.md "NPC") para terminar de ler e lhe dar sua [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência").
   - 20.000 de base
   - 1.000 de classe
...
10. Dentro do laboratório, caminhe ao redor máquina central (ein\_in01 261,35)
    ...
    - Estes números não podem ser repetidos e devem estar na ordem correta definida pelo [NPC](../../Redirecionamentos/NPC.md "NPC").
...
*Importado da [bROWiki](https://browiki.org/wiki/Segredos_do_Aeroplano) — revisão 27916*
