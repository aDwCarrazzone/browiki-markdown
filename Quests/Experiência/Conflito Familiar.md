...
3. Entregue o [Baú de Negócios](http://www.divine-pride.net/database/item/6930/) para Wolf Lugenburg.
   - Digite a senha: `1618`
4. Em [Prontera](../../Lugares/Prontera.md "Prontera"), procure pelas Crianças (prontera 270,69)
   ...
   - Cada criança pedirá um favor em troca de informações.
     ...
     - Coletar 12 [Seda Macia](http://www.divine-pride.net/database/item/7166/)
     - Pegar o livro [A História de Rune-Midgard](http://www.divine-pride.net/database/item/6926/).
5. Para pegar o [A História de Rune-Midgard](http://www.divine-pride.net/database/item/6926/), responda as perguntas da Bibliotecária Séria (prt\_cas 343,68)
   ...
   3. **Quais famílias não participam do banquete?** *Gaebolg e Walther*
   4. **A família ficou muito sujeita à antiga maldição** *Você quer dizer os Gaebolg?*
6. Com os favores completados, volte a falar com as Crianças.
7. Retorne a Wolf Lugenburg (prt\_cas\_q 96,186)
   - Você receberá 1 [Documento Secreto](http://www.divine-pride.net/database/item/6931/).
8. Entregue o item para Isaac Wigner.
9. Volte a falar com Wolf Lugenburg.
   - No meio do diálogo, Maximilian Lugenburg contará a história verdadeira.
...
10. Na fronteira da República, fale com Helmut Lugenburg (yuno\_fild01 242,175)
    ...
    - Depois de finalizar a conversa, você pode usar o [Passaporte para Prontera](http://www.divine-pride.net/database/item/22847/) ou seguir normalmente para [Prontera](../../Lugares/Prontera.md "Prontera").
...
13. Retorne a Maximilian Lugenburg (prt\_cas\_q 90,187)
    - Você receberá 10 [Marcas de Honra](http://www.divine-pride.net/database/item/6919/) e 1.000.000 de [EXP](../../Redirecionamentos/EXP.md "EXP") de base e 500.000 de [EXP](../../Redirecionamentos/EXP.md "EXP") de classe.
14. Ainda no quarto, converse com Agnes Lugenburg.
    ...
    - Ao entregar os itens, você receberá 4 [Marcas de Honra](http://www.divine-pride.net/database/item/6919/) e 200.000 de [EXP](../../Redirecionamentos/EXP.md "EXP") de base e classe.
    - A partir daqui você já pode fazer a missão [Os Lugenburg](As%20Fam%C3%ADlias%20Reais.md#Os_Lugenburg "As Famílias Reais").

---
*Categorias: Quests de experiência, Quests de caça, Quest*  
*Importado da [bROWiki](https://browiki.org/wiki/Conflito_Familiar) — revisão 27867*
