...
1. Fale com o Colecionador Woeon (malaya 295,171)
   ...
   - Selecione:
     ...
     - *Eu cuidarei disso*
2. Colete 30 [Jejellopys](http://www.divine-pride.net/database/item/6498/).
   - Enquanto este passo estiver aberto, os [Jejellopys](http://www.divine-pride.net/database/item/6498/) serão adicionados diretamente no seu inventário ao derrotar [Jejelings](http://www.divine-pride.net/database/monster/2316/).
3. Retorne a Woeon para receber sua recompensa.
   - Cuidado, pois ele recolhe **todos** os [Jejellopys](http://www.divine-pride.net/database/item/6498/) que estiverem no seu inventário.
...
4. Entregue 12 [Braceletes de Prata](http://www.divine-pride.net/database/item/6508/) ao Ferreiro Pandoi (malaya 119,217)
   ...
   - Selecione:
     - *Cruz de Prata*
     - *Fazer 6 Cruzes de Prata*
5. Retorne a Imelda para receber e 200.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") de base e classe.
6. Aguarde 10 minutos e depois fale com Imelda novamente e ajude-a na entrega das [Proteções Espirituais](http://www.divine-pride.net/database/item/6503/) para cada [NPC](../../Redirecionamentos/NPC.md "NPC") abaixo:
...
7. Retorne a Imelda para receber e 200.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") de base e classe.
...
| **[EXP classe](../../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 200.000 |
| **[Itens](../../Itens/Itens.md "Itens")** | ![6497.png](https://static.divine-pride.net/images/items/item/6497.png) 1 [Amuleto Menor](http://www.divine-pride.net/database/item/6497/) |
| **Recompensa** | Libera viagem a [Izlude](../../Lugares/Izlude.md "Izlude") por 1.000 [zenys](../../Redirecionamentos/Zenys.md "Zenys") |
...
7. Reencontre a Fantasma Diwata, aproximando-se dela, deslize o buquê pelo chão.
8. Retorne ao Marinheiro Pedro para receber sua recompensa.
...
| **Quests anteriores** | [Vila Cautelosa](Vila%20Cautelosa.md "Vila Cautelosa") [Enfermeira em Porto Malaya](../../Calabou%C3%A7os%20e%20Inst%C3%A2ncias/Enfermeira%20em%20Porto%20Malaya.md "Enfermeira em Porto Malaya") |
| ![Skilldelayinfo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/84/Skilldelayinfo.png) **Espera:** | 4 da manhã |
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 200.000 |
| **[EXP classe](../../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 200.000 |
...
1. Encontre o Ferreiro Pandoi (malaya 119,217)
   ...
   - Selecione:
     - *Espada de Prata*
     - *Eu cuidarei disso*
2. Após a caça, volte a Pandoi para receber sua recompensa.
...
1. Fale com o Guarda Dhong (ma\_fild01 239,253)
   ...
   - Selecione:
     ...
     - *Eu cuidarei disso*
2. Colete 10 [Ossos Malignos de Espírito](http://www.divine-pride.net/database/item/6507/) derrotando [Tiyanaks](http://www.divine-pride.net/database/monster/2314/), [Bungisngis](http://www.divine-pride.net/database/monster/2309/) ou [Tikbalangs](http://www.divine-pride.net/database/monster/2313/).
...
1. Encontre o Capre Bom Budidai (ma\_fild02 241,39)
   ...
   - Selecione:
     ...
     - *Devo cuidar disso?*
2. Após a caçada, retorne ao Capre Bom Budidai para receber sua recompensa.
