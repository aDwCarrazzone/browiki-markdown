...
6. Após um determinado tempo, Ibanoff pede para você checar o convés. Basta andar em direção à ponta do barco.
   ...
   - Observações:
     - Repita os passos 4 e 5 até acontecer um ataque de [monstros](../../Sistema%20e%20Mec%C3%A2nicas/Monstros.md "Monstros");
     - Os monstros são [Hidras](http://www.divine-pride.net/database/monster/1068/), [Tritões](http://www.divine-pride.net/database/monster/1264/), [Kaphas](http://www.divine-pride.net/database/monster/1406/), [Peixes-Espada](http://www.divine-pride.net/database/monster/1069/) e [Obeunes](http://www.divine-pride.net/database/monster/1044/), de acordo com seu nível de base;
     - Você não perde [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") caso morra no barco;
     - O [NPC](../../Redirecionamentos/NPC.md "NPC") só pedirá para checar o convés após a luta com os [monstros](../../Sistema%20e%20Mec%C3%A2nicas/Monstros.md "Monstros").
...
13. Explique a situação ao Senhor Estranho. Ele pedirá alguns itens e mesmo que você já os tenha, precisa selecionar a opção "*Estou Pronto*" para voltar a [Moscóvia](../../Lugares/Mosc%C3%B3via.md "Moscóvia").
14. Retorne para a Ilha-Baleia e entregue os itens ao Senhor Estranho para receber um [Gusli](http://www.divine-pride.net/database/item/2707/).
    - Selecione "*Eu quero aprender a tocar o Gusli*"
    - Converse várias vezes com o [NPC](../../Redirecionamentos/NPC.md "NPC") até aprender a tocá-lo.
15. Retorne ao Czar Alexei III com o [Gusli](http://www.divine-pride.net/database/item/2707/) equipado.
    - Observe que a premiação da [quest](../../Redirecionamentos/Quest.md "Quest") varia de acordo com as opções:
      - Se você aprendeu a tocar e se apresentar ao Czar: *100.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") e 1 [Velha Caixa Roxa](http://www.divine-pride.net/database/item/617/)*.
      - Se não aprendeu a tocar e não se apresentar ao Czar: *70.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") e 1 [Velha Caixa Azul](http://www.divine-pride.net/database/item/603/)*.
      - Se não aprendeu a tocar e se apresentar ao Czar: *50.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") e 1 [Velha Caixa Azul](http://www.divine-pride.net/database/item/603/)*.
16. Agora você tem acesso aos arredores de [Moscóvia](../../Lugares/Mosc%C3%B3via.md "Moscóvia").
    - Para chegar na Ilha-Baleia, equipe o [Gusli](http://www.divine-pride.net/database/item/2707/) e aproxime-se do Sr. Ibanoff.
    - Para ter acesso a [mosk\_fild02](http://www.divine-pride.net/database/map/mosk_fild02/), aventure-se com o Senhor Estranho.
    - Para retornar a [Moscóvia](../../Lugares/Mosc%C3%B3via.md "Moscóvia"), clique no Barco (mosk\_fild02 198,53)

    :   :   ![Mosk06](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/b/b8/Mosk06.png)

---
*Categorias: Quests de experiência, Quest*  
*Importado da [bROWiki](https://browiki.org/wiki/Encontrando_a_Ilha-Baleia) — revisão 43891*
