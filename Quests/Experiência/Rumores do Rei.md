...
| **Quests anteriores** | [Garoto Sonhador](../../Calabou%C3%A7os%20e%20Inst%C3%A2ncias/Garoto%20Sonhador.md "Garoto Sonhador") até o passo 3. |
| Premiação | |
...
8. Pegue o [Pacote de Correio](http://www.divine-pride.net/database/item/6552/) com o Diretor do Escritório (splendide 267,368)
   ...
   - O [NPC](../../Redirecionamentos/NPC.md "NPC") fica na parte de cima, o acesso pode ser feito a partir de (splendide 249,244)
...
10. Converse com o Guarda de Eclage, Leo. (eclage 111,41)
    ...
    - Esses itens podem ser comprados em [Esplendor](../../Lugares/Esplendor.md "Esplendor") usando [Moeda Esplendor](http://www.divine-pride.net/database/item/6081/).
      - As moedas podem ser adquiridas de várias formas, a mais fácil é através da missão diária [Perfume de Alfheim](Aventuras%20no%20Novo%20Mundo.md#Perfume_de_Álfheim "Aventuras no Novo Mundo").
        - Você não precisa completar a missão [Anel do Rei Sábio](Anel%20do%20Rei%20S%C3%A1bio.md "Anel do Rei Sábio") caso já tenha o anel, basta equipá-lo e falar com a Mercadora de Esplendor (splendide 198,237)
      - Cada moeda compra 3 unidades de geleia.
      - As geleias não podem ser negociadas ou enviadas por [RODEX](../../Redirecionamentos/RODEX.md "RODEX"), apenas guardadas no [Armazém](../../Redirecionamentos/Armaz%C3%A9m.md "Armazém").
...
*Importado da [bROWiki](https://browiki.org/wiki/Rumores_do_Rei) — revisão 34706*
