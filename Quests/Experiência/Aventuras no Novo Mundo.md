...
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 40.000 |
| **[EXP classe](../../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 40.000 |
...
2. Colete 10 [Ovos de Dragão](http://www.divine-pride.net/database/item/6093/) clicando nos Ovos de Draco espalhados na [Grande Ferida](http://www.divine-pride.net/database/map/nyd_dun01/).
   ...
   - Ao coletar um Ovo, o [NPC](../../Redirecionamentos/NPC.md "NPC") desaparece e reaparece após 7 minutos.
   ...
   - Coordenadas:
     ...
     - (nyd\_dun01 59,185)
     - (nyd\_dun02 202,166)
3. Entregue os [Ovos de Dragão](http://www.divine-pride.net/database/item/6093/) para Pinedel recompensar você.
...
| ![Skilldelayinfo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/84/Skilldelayinfo.png) **Espera:** | 4 da manhã |
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 30.000 |
| **[EXP classe](../../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 30.000 |
...
| ![Skilldelayinfo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/84/Skilldelayinfo.png) **Espera:** | 4 da manhã |
| Premiação | |
| **[EXP classe](../../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 70.000 |
| **[Itens](../../Itens/Itens.md "Itens")** | ![6081.png](https://static.divine-pride.net/images/items/item/6081.png) 3 [Moedas Esplendor](http://www.divine-pride.net/database/item/6081/) |
...
6. Use os [Espíritos de Alfheim](http://www.divine-pride.net/database/item/6082/) em 5 dos Soldados Exaustos espalhados na cidade. Existem 7 deles e reaparecem a cada 1 minuto.
   ...
   - (splendide 181,135)
   - (splendide 205,139)
7. Reencontre a Cientista para receber sua premiação.
...
1. Fale com o Cientista (man\_in01 372,220)
   ...
   - Selecione:
     - *Uma doença crônica?*
   - Você receberá [Caixa de Ferramentas Portátil](http://www.divine-pride.net/database/item/6076/).
2. De acordo com a região que o Cientista mencionou, colete os [Minerais Brutos](http://www.divine-pride.net/database/item/6077/).
   - Quando chegar nos mapas indicados, uma janela de diálogo surge. Você deve escolher a opção "*Conferir local atual*" para marcar a localização das pedras no mini-mapa.
   - Ao minerar, você pode receber 1, 2 ou 5 [Minerais Brutos](http://www.divine-pride.net/database/item/6077/) de uma só vez.
   - Em caso de sucesso, a pedra some e só reaparecerá depois de alguns minutos.
   - Em caso de falha, você recebe um [Fragmento de Pedra](http://www.divine-pride.net/database/item/6078/).
   - Se você desejar remover a missão da sua janela de [quests](../Gerais/Quests.md "Quests") após completá-la, basta falar com o [NPC](../../Redirecionamentos/NPC.md "NPC") e não continuar o diálogo.
3. As pedras estão localizadas nos seguintes lugares:
   ...
   3. Monte Mjolnir: 10 [Minerais Brutos](http://www.divine-pride.net/database/item/6077/)
      ...
      - (mjolnir\_10 189,261)
      - (mjolnir\_09 228,215)
4. Retorne ao Cientista para receber sua recompensa.
...
*Importado da [bROWiki](https://browiki.org/wiki/Aventuras_no_Novo_Mundo) — revisão 47341*
