...
5. Procure pelo Entregador de Móveis (prontera 68,68)
   ...
   - Entregue 3 [Medalhões de Carne](http://www.divine-pride.net/database/item/6254/) para o [NPC](../../Redirecionamentos/NPC.md "NPC").
6. Converse com Jurgen Wigner, no Palácio (prt\_cas\_q 97,6)
   ...
   - Ao entregar as [Pedras do Mar](http://www.divine-pride.net/database/item/6927/), o [NPC](../../Redirecionamentos/NPC.md "NPC") remove todas elas do inventário.
7. Entregue os itens a Jurgen Wigner para receber sua recompensa.
   - Você receberá 1.000.0000 de [EXP](../../Redirecionamentos/EXP.md "EXP") base, 500.000 de [EXP](../../Redirecionamentos/EXP.md "EXP") base e 10 [Marcas de Honra](http://www.divine-pride.net/database/item/6919/).
...
11. Com os itens no inventário, dirija-se para a Empregada.
    - Ao entregar as [Pedras do Mar](http://www.divine-pride.net/database/item/6927/), a [NPC](../../Redirecionamentos/NPC.md "NPC") remove todas elas do inventário.
12. Conte o relato a Jurgen Wigner para receber sua recompensa.
    - Você receberá 200.000 de [EXP](../../Redirecionamentos/EXP.md "EXP") de base, classe e 4 [Marcas de Honra](http://www.divine-pride.net/database/item/6919/).
    - A partir daqui, você já pode fazer a missão [Os Wigner](As%20Fam%C3%ADlias%20Reais.md#Os_Wigner "As Famílias Reais")

---
*Categorias: Quests de experiência, Quests de caça, Quest*  
*Importado da [bROWiki](https://browiki.org/wiki/Valor_Sentimental) — revisão 34561*
