...
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 10.000 |
...
4. Pague 10.000 [zenys](../../Redirecionamentos/Zenys.md "Zenys") ao Soldado (lou\_in02 210,47)
...
5. Fale com o Homem dos Papéis (lou\_in02 156,38)
   ...
   - Digite corretamente o formulário dado pelo Especialista em Lanças:
     ...
     - `Formulário de requisição do exame de matemática`
6. Retorne ao Especialista em Lanças, que entregará um [Remédio Oriental](http://www.divine-pride.net/database/item/7252/).
7. Entregue o item para a Doutora, agora você deve aceitar ajudá-la mais uma vez.
   - Traga os itens pedidos pela [NPC](../../Redirecionamentos/NPC.md "NPC") para receber 10.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") e 5 [Pílulas Douradas](http://www.divine-pride.net/database/item/679/).
   - Se você se recusar a ajudá-la, você receberá apenas 1.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") e 2 [Pílulas Douradas](http://www.divine-pride.net/database/item/679/).
   - As [Pílulas Douradas](http://www.divine-pride.net/database/item/679/) recuperam [cegueira](../../Redirecionamentos/Cegueira.md "Cegueira"), [maldição](../../Redirecionamentos/Maldi%C3%A7%C3%A3o.md "Maldição"), [caos](../../Redirecionamentos/Caos.md "Caos"), [envenenamento](../../Redirecionamentos/Envenenamento.md "Envenenamento") e [silêncio](../../Redirecionamentos/Sil%C3%AAncio.md "Silêncio").

---
*Categorias: Quests de experiência, Quest*  
*Importado da [bROWiki](https://browiki.org/wiki/Erva_Medicinal) — revisão 43987*
