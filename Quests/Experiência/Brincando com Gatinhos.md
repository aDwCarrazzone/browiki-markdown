...
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 20.000 |
...
| **Recompensa** | Libera a [Corrida Duruduru](Corrida%20Duruduru.md "Corrida Duruduru") e a [Máquina Barulhenta](M%C3%A1quina%20Barulhenta.md "Máquina Barulhenta") |
...
3. Clique na Bússola Iniciante (malangdo 21,204)
   ...
   - Atente-se para o texto da janela de missões para saber **qual a ordem** das bússolas.
   - Ao encontrar uma bússola, você deve resolver um problema matemático, portanto, tenha uma calculadora por perto.
   - Assim que passar da última bússola, toque o Meowbell (malangdo 175,163)
   - As bússolas são:
     - Bússola da Chama Azul (malangdo 128,103)
     - Bússola da Floresta (malangdo 153,146)
     - Bússola da Chama Dourada (malangdo 73,253)
...
6. Insira o [Cartão de Aventura B](http://www.divine-pride.net/database/item/6429/) na Máquina Barulhenta (malangdo 174,175)
   ...
   - Sua tarefa é substituir a cor da sequência por outra. É confuso, mas não é difícil:
     - Se a máquina exibir Vermelho escolha Verde.
     - Se a máquina exibir Verde escolha Vermelho.
     - Se a máquina exibir Azul escolha Amarelo.
     - Se a máquina exibir Amarelo escolha Azul.
7. Após o resultado, fale com o Detetive.
   - Se não conseguir, você precisa comprar o [Cartão de Aventura B](http://www.divine-pride.net/database/item/6429/) por 1 [Peixe Enlatado de Malangdo](http://www.divine-pride.net/database/item/12636/) e tentar novamente.
8. Procure por [Pedaços de Pintura](http://www.divine-pride.net/database/item/6430/) nos objetos espalhados no navio. A ordem é aleatória e se um [NPC](../../Redirecionamentos/NPC.md "NPC") expulsar você, tente outros locais primeiro.
   1. Caixa (mal\_in02 185,45)
   2. Livros (mal\_in02 169,73)
   3. Cama Suja (mal\_in02 133,98)
   4. Concha (mal\_in02 31,58)
   5. ?? (mal\_in02 113,56)
...
11. Entregue a pintura ao Gato Especialista (malangdo 165,222)
    - Você receberá 100 [Moedas Classe E](http://www.divine-pride.net/database/item/6422/) e poderá visualizar a pintura.

---
*Categorias: Quests de experiência, Quest*  
*Importado da [bROWiki](https://browiki.org/wiki/Brincando_com_Gatinhos) — revisão 39020*
