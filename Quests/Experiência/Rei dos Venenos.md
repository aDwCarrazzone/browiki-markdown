...
| **[Zeny](../../Redirecionamentos/Zeny.md "Zeny")** | 1.000 |
...
7. Entregue o item ao Bibliotecário para ele tentar fazer 2 [Garrafas de Veneno](http://www.divine-pride.net/database/item/678/).
   - Há chances falha nesse processo, então colete várias quantidades dos itens que ele pede, mas não mantenha todos no inventário, pois o [NPC](../../Redirecionamentos/NPC.md "NPC") pega todos os itens que estiverem com você.
   - Itens necessários:
   ...
   - Em caso de sucesso, clique novamente no [NPC](../../Redirecionamentos/NPC.md "NPC") para a próxima missão.
...
14. Encontre o Bibliotecário para ganhar 5 [Garrafas de Veneno](http://www.divine-pride.net/database/item/678/), 1 [Velha Caixa Azul](http://www.divine-pride.net/database/item/603/) e [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência"), que varia de acordo com seu nível:
...
*Importado da [bROWiki](https://browiki.org/wiki/Rei_dos_Venenos) — revisão 27827*
