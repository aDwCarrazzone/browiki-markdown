...
| ![DQ ico](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/8b/DQ_ico.png) Aventuras em Eclage | |
| --- | --- |
| Requisitos mínimos | |
| **Nv. de base** | 120 |
| **Tipo** | Repetível |
| **[Itens](../../Itens/Itens.md "Itens")** | ![6558.png](https://static.divine-pride.net/images/items/item/6558.png) 10 [Pilha de Avelãs](http://www.divine-pride.net/database/item/6558/)  ![6560.png](https://static.divine-pride.net/images/items/item/6560.png) 20 [Trevo Marca Páginas](http://www.divine-pride.net/database/item/6560/)  ![517.png](https://static.divine-pride.net/images/items/item/517.png) 10 [Carnes](http://www.divine-pride.net/database/item/517/) |
| **Caça** | 20 [Cenere](http://www.divine-pride.net/database/monster/2365/) |
| **Quests anteriores** | [Garoto Sonhador](../../Calabou%C3%A7os%20e%20Inst%C3%A2ncias/Garoto%20Sonhador.md "Garoto Sonhador") |
| ![Skilldelayinfo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/84/Skilldelayinfo.png) **Espera:** | 4 da manhã |
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 1.500.000 |
| **[EXP classe](../../Redirecionamentos/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 1.500.000 |
| **[Itens](../../Itens/Itens.md "Itens")** | ![6081.png](https://static.divine-pride.net/images/items/item/6081.png) 5 [Moedas Esplendor](http://www.divine-pride.net/database/item/6081/) |
...
3. Retorne ao Fili, que agradecerá:
   ...
   - 300.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") de base e classe.
4. Converse mais uma vez com Fili.
   - Selecione:
     - *Verificando os aventureiros*
...
7. Reencontre Novo Oz, que pedirá uma série de favores. Cada favor valerá 1 [Moeda Esplendor](http://www.divine-pride.net/database/item/6081/) e 300.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") de base e classe.
   1. **Ajudando a comer**: Entregue 10 [Carnes](http://www.divine-pride.net/database/item/517/) e 10 [Pilhas de Avelãs](http://www.divine-pride.net/database/item/6558/).
   2. **Tirando o pó**: Derrote 20 [Ceneres](http://www.divine-pride.net/database/monster/2365/).
   3. **Coletando lembrança**: Traga 20 [Trevos Marca Páginas](http://www.divine-pride.net/database/item/6560/).
8. Volte ao Fili para receber sua recompensa:
   - 1 [Moeda Esplendor](http://www.divine-pride.net/database/item/6081/)
   - 300.000 de [experiência](../../Redirecionamentos/Experi%C3%AAncia.md "Experiência") de base e classe.
   - Ao refazer a missão "*Verificando os aventureiros*", você não precisará completar os favores do Novo Oz. Basta falar com o [NPC](../../Redirecionamentos/NPC.md "NPC") e retornar a Fili.
   - Mas será necessário completar as missões do Novo Oz se deseja as 3 moedas das tarefas.
   - Fili só entregará as carnes na primeira vez fazendo a quest.
...
| **Nv. de base** | 120 |
| **Tipo** | Repetível |
| **Caça** | 5 [Menblatt](http://www.divine-pride.net/database/monster/2363/) e 5 [Petals](http://www.divine-pride.net/database/monster/2364/). |
| **Quests anteriores** | [Rumores do Rei](Rumores%20do%20Rei.md "Rumores do Rei") |
| ![Skilldelayinfo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/84/Skilldelayinfo.png) **Espera:** | 4 da manhã |
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 200.000 |
...
| **Nv. de base** | 99 |
| **Tipo** | Repetível |
| **[Itens](../../Itens/Itens.md "Itens")** | ![6023.png](https://static.divine-pride.net/images/items/item/6023.png) 10 [Chifres Místicos](http://www.divine-pride.net/database/item/6023/)  ![944.png](https://static.divine-pride.net/images/items/item/944.png) 10 [Ferraduras](http://www.divine-pride.net/database/item/944/)  ![6032.png](https://static.divine-pride.net/images/items/item/6032.png) 10 [Chifres de Leão](http://www.divine-pride.net/database/item/6032/) |
| **Quests anteriores** | [Rumores do Rei](Rumores%20do%20Rei.md "Rumores do Rei") |
| ![Skilldelayinfo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/84/Skilldelayinfo.png) **Espera:** | 4 da manhã |
| Premiação | |
| **[EXP base](../../Redirecionamentos/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 200.000 |
...
*Importado da [bROWiki](https://browiki.org/wiki/Aventuras_em_Eclage) — revisão 47338*
