...
source: https://browiki.org/wiki/Gest%C3%A3o_de_Lojas
namespace: 0
revision: 39779
...
| **Tipo** | Repetível |
| **Caça** | Ver tabela |
| **[Zeny](Zeny.md "Zeny")** | Opcional |
| Premiação | |
| **Recompensa** | Libera a [Lojinha de Rua](Lojinha de Rua.md "Lojinha de Rua") |

![Alberta city](images/c/cf/Alberta_city.jpg)

Para usar uma [Lojinha de Rua](Lojinha de Rua.md "Lojinha de Rua"), você deverá participar da União de Gestão de Lojas.

1. Fale com Masha (alberta\_in 20,19)

   :   ![MashaRH](images/8/82/MashaRH.png)

   - Esta [NPC](NPC.md "NPC") dará duas opções:
     - Realizar 1 missão a cada 7 dias ou
     - Pagar pelos Passes por [zenys](Zeny.md "Zeny").
   - Confira as missões e os preços abaixo.

1. Você também pode falar com Ridwan do RH (alberta\_in 20,21)

   :   ![RidwanRH](images/9/97/RidwanRH.png)

   - Por 3 Passes de 1 dia, o [NPC](NPC.md "NPC") dará 1 Passe de 3 dias.

## Por zenys

- Podem ser comprados quantas vezes quiser, ilimitadamente.
- Até 30 unidades podem ser compradas de uma vez só, mas você pode ter mais passes no inventário.
...
- As missões dadas por Masha são aleatórias.
- Ao pegar uma missão, é possível cancela-lá para gerar uma nova missão.
- Assim que completá-las, você poderá escolher entre o Passe de Compras e o Passe de Vendas.
- Se você deseja o passe básico, você deverá realizar apenas as missões básicas.
- Você não pode fazer mais de uma missão ao mesmo tempo.
- As missões de entrega pedem que você entregue ou receba uma [Caixa Desgastada](http://www.divine-pride.net/database/item/25359/) dos [NPCs](NPC.md "NPC").
- As missões de caça exigem que você retorne para a Ovelhinha na guilda dos mercadores em [Alberta](Alberta.md "Alberta") para receber 1 [Recibo](http://www.divine-pride.net/database/item/25360/).

| Missões básicas | | |
| --- | --- | --- |
| Missão | [NPC](NPC.md "NPC") | Coordenadas |
...
| Eliminar 3 [Kathryne Keyron](http://www.divine-pride.net/database/monster/1639/) | Reporte para a Ovelhinha na Guilda | - |
