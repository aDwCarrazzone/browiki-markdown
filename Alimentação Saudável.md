...
source: https://browiki.org/wiki/Alimenta%C3%A7%C3%A3o_Saud%C3%A1vel
namespace: 0
revision: 27743
...
| **Nv. de base** | Nenhum |
| **Tipo** | Repetível |
| **[Itens](Itens.md "Itens")** | 517.png 1 [Carne](http://www.divine-pride.net/database/item/517/) |
| Premiação | |
...
4. Agora você poderá fazer sucos com Marxhansen! Basta trazer os ingredientes abaixo e 3 [zenys](Zenys.md "Zenys").
   - Você pode optar por produzir Sucos diretamente através do [Kit de Culinária de Iniciante](Culinária.md "Culinária"), sem precisar ter completado essa missão.
   - Ingredentes em verde podem ser comprados em [NPC](NPC.md "NPC").
