...
| **Duração:** | Ver tabela |
| **[Ícone](../../Redirecionamentos/%C3%8Dcone.md "Ícone"):** | ![I Marcar em Brasa](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/3/34/I_Marcar_em_Brasa.png) |

Trava uma mira no alvo, que dura por alguns segundos.

A cada 1 segundo, o alvo sofrerá dano fixo de 30.000 de [HP](../../Redirecionamentos/HP.md "HP").
...
- *Confira a lista de [monstros](../../Sistema%20e%20Mec%C3%A2nicas/Monstros.md "Monstros") que usam [Laser Rastreador](http://www.divine-pride.net/database/skill/773)*
- O ataque cai na célula em que o personagem se encontra. Caso o jogador se mova antes do ataque, ele não será atingido.
- A mira não pode ser removida por [Desencantar](../Especiais/Desencantar.md "Desencantar") ou [Gênese](../Especiais/G%C3%AAnese.md "Gênese").
- O dano não pode ser bloqueado por [Imunidade Mágica](../Passiva/Imunidade%20M%C3%A1gica.md "Imunidade Mágica").
- O dano é fixo, ignorando [DEF](../../Redirecionamentos/DEF.md "DEF") e [DEFM](../../Redirecionamentos/DEFM.md "DEFM"), mas pode ser reduzido por:
...
- Pode ser esquivada por [Cambalhota](../Especiais/Cambalhota.md "Cambalhota").
...
*Importado da [bROWiki](https://browiki.org/wiki/Laser_Rastreador) — revisão 43876*
