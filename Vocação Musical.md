---
title: "Vocação Musical"
source: https://browiki.org/wiki/Voca%C3%A7%C3%A3o_Musical
namespace: 0
revision: 46687
...
|  |  |
| --- | --- |
| **Vocação Musical Vocação Musical** | |
| Vocação Musical | |
| **Skilled Special Singer** | |
| **ID** | CG\_SPECIALSINGER (5068) |
| **Tipo** | Suporte |
| **Níveis** | 1 |
| **[SP](SP.md "SP")** | 1 |
...
| **Pré-requisitos** | |
| - Menestréis [Dissonância](Dissonância.md "Dissonância") [Dissonância](Dissonância.md "Dissonância") Nv. 3 [Lições de Música](Lições de Música.md "Lições de Música") [Lições de Música](Lições de Música.md "Lições de Música") Nv. 10 [Controle de Marionete](Controle de Marionete.md "Controle de Marionete") [Controle de Marionete](Controle de Marionete.md "Controle de Marionete") Nv. 1 - Ciganas [Dança do Ventre](Dança do Ventre.md "Dança do Ventre") [Dança do Ventre](Dança do Ventre.md "Dança do Ventre") Nv. 3 [Lições de Dança](Lições de Dança.md "Lições de Dança") [Lições de Dança](Lições de Dança.md "Lições de Dança") Nv. 10 [Controle de Marionete](Controle de Marionete.md "Controle de Marionete") [Controle de Marionete](Controle de Marionete.md "Controle de Marionete") Nv. 1 | |

Pelo seu talento na arte, o início de um dueto não será tão puxado para você.

Remove o efeito de Cansaço do usuário.

### Cansaço

[Ícone](Ícone.md "Ícone"): ![I Cansaço](images/c/c9/I_Cansaço.png)

- Dura 10 segundos.
- Recebe essa condição logo após ativar um dueto.
- Enquanto estiver ativa, o usuário terá os seguintes efeitos:
  - Não pode usar [habilidades](Habilidades.md "Habilidades").
  - [Velocidade de ataque](Velocidade de ataque.md "Velocidade de ataque") -30%.
  - Velocidade de movimento -30%.
- Não pode ser removida por [Desencantar](Desencantar.md "Desencantar") e [Gênese](Gênese.md "Gênese"), mas é cancelada ao morrer.

## Notas

- Nova versão da antiga habilidade *Grito de Liberdade*.
...
| |  |  | | --- | --- | | [Ciganaspartyicn](Ciganas.md "Ciganas") | [Ciganas](Ciganas.md "Ciganas") | | [Bastão de Hermod](Bastão de Hermod.md "Bastão de Hermod") · [Controle de Marionete](Controle de Marionete.md "Controle de Marionete") · [Destino nas Cartas](Destino nas Cartas.md "Destino nas Cartas") · Vocação Musical · [Vulcão de Flechas](Vulcão de Flechas.md "Vulcão de Flechas") [Bênção Protetora](Bênção Protetora.md "Bênção Protetora") |
