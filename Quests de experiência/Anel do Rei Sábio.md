...
| ![EP ico](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/3/3f/EP_ico.png) Anel do Rei Sábio | |
| --- | --- |
| Para entender o idioma dos Esplêndidos e Manuks, será necessária a colaboração dos três continentes para produzir um mecanismo de tradução instantânea. | |
| Requisitos mínimos | |
| **Nv. de base** | 70 |
| **Tipo** | Episódio |
| **Quests anteriores** | [A Fada e a Árvore](A%20Fada%20e%20a%20%C3%81rvore.md "A Fada e a Árvore") [Descobrindo um Novo Ambiente](Descobrindo%20um%20Novo%20Ambiente.md "Descobrindo um Novo Ambiente") |
| Premiação | |
| **[EXP base](../Sem%20categoria/Experi%C3%AAncia%20de%20Base.md "Experiência de Base")** | 200.000 |
| **[EXP classe](../Sem%20categoria/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 5.000 |
| **[Itens](../Itens/Itens.md "Itens")** | ![2782.png](https://static.divine-pride.net/images/items/item/2782.png) 1 [Anel do Rei Sábio](http://www.divine-pride.net/database/item/2782/) |
...
9. Retorne ao Mago de Rune-Midgard (mid\_camp 147,256)
   - Ele pedirá 1 [Mineral Não Identificado](http://www.divine-pride.net/database/item/6048/) que você consegue na [mineração](Servi%C3%A7o%20Felino.md#Mineração "Serviço Felino").
   - Insista na conversa com o [NPC](../Sem%20categoria/NPC.md "NPC") até ele aceitar o [Mineral Não Identificado](http://www.divine-pride.net/database/item/6048/)
10. Fale com o Engenheiro Mecânico (mid\_camp 197,236)
11. Retorne novamente para falar com o Mago de Rune-Midgard. (mid\_camp 147,256)
