...
| **[EXP classe](../Sem%20categoria/Experi%C3%AAncia%20de%20Classe.md "Experiência de Classe")** | 850.000 |
...
9. Entre no Yai Comum. Você terá 5 minutos para examinar a mesa.
   ...
   - Selecione:
     ...
     - *Tentar rearranjar os livros*
     - *A sequência é*: Segundo → Quarto → Primeiro → Terceiro → Quinto
     - *Olhar o aparelho com dobradiça no topo da mesa*
   - Digite
     - `31425`
...
10. O Pesquisador aparecerá com 5 [Criações de Avant](http://www.divine-pride.net/database/monster/1198/).
    ...
    - Nesta etapa, você pode optar por:
      ...
      - Estou tomando conta deste lugar (*Luta contra os monstros*)
11. Volte ao Rei Jun Kardui e aceite proteger a Orbe. Você receberá [experiência](../Sem%20categoria/Experi%C3%AAncia.md "Experiência").
    - Se você batalhou contra as [Criações de Avant](http://www.divine-pride.net/database/monster/1198/):
      - 400.000 de base
      - 300.000 de classe
    - Se você fugiu ou morreu na batalha:
      - 350.000 de base
      - 250.000 de classe
12. Retorne para a Torre de Bifröst e fale com Hisie
...
13. Fale com a Chefe do Gabinete.
    ...
    - Selecione:
      ...
      - *Também não sei*
14. Retorne ao Rei Kardui e aceite ajudá-lo.
15. Volte a falar com a Chefe do Gabinete.
...
19. Clique na Entrada Proibida ao lado de Shenime para acessar, você tem 20 minutos para completá-la.
    ...
    3. Circule novamente o centro do mapa até uma nova mensagem surgir.
