...
| **Nv. de base** | 110 |
| **Tipo** | Normal |
| **Caça** | [Miguel](http://www.divine-pride.net/database/monster/20347/) |
...
1. No Distrito COR, fale com Est (sp\_cor 164,56) para gerar a instância.
   ...
   - Essa [NPC](../Sem%20categoria/NPC.md "NPC") é cinemática, ou seja, só aparece para seu personagem e só quando você se aproxima.
2. Dentro da instância, espere a introdução finalizar e os [NPCs](../Sem%20categoria/NPC.md "NPC") sumirem.
3. Como pedido pela comandante, fique no local, basta ir enfrentando alguns monstros.
4. Quando o anúncio pedir que a *Equipe Eco* se comunique, basta clicar no robô e selecionar qualquer opção.

   :   ![WalkieTalkie](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/d/d6/WalkieTalkie.png)
5. Após a ajuda do Esquadrão Anti-Bomba, siga pela [navegação](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Navega%C3%A7%C3%A3o.md "Navegação").
   - Fale com o robô e continue seguindo a navegação e matando monstros no caminho.
   - É importante que você **AGUARDE** um pouco após derrotar os monstros, pois o [NPC](../Sem%20categoria/NPC.md "NPC") de navegação leva um tempo para aparecer.
   - Sempre que você eliminar os mutantes remanescentes, a ocupação estará concluída e uma luz azul aparecerá, aproxime-se dela para indicar o próximo caminho.
6. Enfrente Miguel, com [HP](../Sem%20categoria/HP.md "HP") menor que o original e depois, fale com Est.
