...
7. Entregue o item ao Bibliotecário para ele tentar fazer 2 [Garrafas de Veneno](http://www.divine-pride.net/database/item/678/).
   - Há chances falha nesse processo, então colete várias quantidades dos itens que ele pede, mas não mantenha todos no inventário, pois o [NPC](../Sem%20categoria/NPC.md "NPC") pega todos os itens que estiverem com você.
   - Itens necessários:
   ...
   - Em caso de sucesso, clique novamente no [NPC](../Sem%20categoria/NPC.md "NPC") para a próxima missão.
