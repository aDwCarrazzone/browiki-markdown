...
3. Siga pela navegação:
   1. Encontre uma Caixa (oz\_dun01 26,184)
   2. Desça pelo Caminho Íngreme (oz\_dun01 65,189)
   3. Clique no Vapor (oz\_dun01 111,96)
4. Converse com ??? (oz\_dun01 100,92)

   :   [não adicione imagem](https://browiki.org/index.php?title=Especial:Carregar_arquivo&wpDestFile=Mercador_de_Oz02.png "Arquivo:Mercador de Oz02.png")
5. Elimine 10 espécies de monstros do [Labirinto de Oz](http://www.divine-pride.net/database/map/oz_dun01/) e retorne a ??? (oz\_dun01 100,92).
6. Continue pela navegação:
   1. Encontre outra Caixa (oz\_dun01 134,56)
   2. Clique nas faíscas (oz\_dun01 110,37) e vá para o 2º andar.
   3. No 2º andar, clique nas Faíscas (oz\_dun02 150,275).
7. Fale com o Velho (oz\_dun02 150,275).
...
- Todas as missões diárias são iniciadas por Imril (wolfvill 143,113).
