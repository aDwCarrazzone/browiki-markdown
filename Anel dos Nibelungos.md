---
title: "Anel dos Nibelungos"
source: https://browiki.org/wiki/Anel_dos_Nibelungos
namespace: 0
revision: 46677
...
|  |  |
| --- | --- |
| **Anel dos Nibelungos Anel dos Nibelungos** | |
| Anel dos Nibelungos | |
| **Harmonic Lick / Fraseo Armónico** | |
| **ID** | BD\_RINGNIBELUNGEN (310) |
| **Tipo** | Suporte |
| **Níveis** | 5 |
| **[SP](SP.md "SP")** | 68 - (Nv. da habilidade × 4) |
| **[Conjuração](Conjuração.md "Conjuração")** | 0,5 + 3 seg. |
...
| **Ícone** | I Anel de Nibelungos |
| **Áudio** | <https://browiki.org/wiki/Arquivo:Anel_dos_Nibelungos.mp3> |
| **Pré-requisitos** | |
| - [Rufar dos Tambores](Rufar dos Tambores.md "Rufar dos Tambores") [Rufar dos Tambores](Rufar dos Tambores.md "Rufar dos Tambores") Nv. 3 | |

Inicia um dueto refinado.

O usuário e membros do [grupo](Grupo.md "Grupo") receberão um efeito aleatório temporariamente.
...
1. [Esquiva](Esquiva.md "Esquiva") +50.
2. [Precisão](Precisão.md "Precisão") +50.
3. [HP](HP.md "HP") máx. +30%.
4. [SP](SP.md "SP") máx. +30%.
5. Todos os [atributos](Atributos.md "Atributos") +15.
6. Dano mágico +20%.
7. Dano físico contra todas as raças +20%.
8. [Velocidade de ataque](Velocidade de ataque.md "Velocidade de ataque") +20%.
9. Regeneração natural de [HP](HP.md "HP") +100%.
10. Regeneração natural de [SP](SP.md "SP") +100%.
11. Custo de [SP](SP.md "SP") das [habilidades](Habilidades.md "Habilidades") -30%.

## Notas

- Todos os efeitos são acumulativos com equipamentos.
- Os efeitos são aleatórios para cada membro do [grupo](Grupo.md "Grupo").
