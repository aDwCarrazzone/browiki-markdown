---
title: "O Presidente"
source: https://browiki.org/wiki/O_Presidente
namespace: 0
revision: 33561
...
| **Nv. de base** | 60 |
| **Tipo** | Episódio |
| **[Itens](Itens.md "Itens")** | 7345.png 10 [Algema de Identificação](http://www.divine-pride.net/database/item/7345/)  7347.png 10 [Tabela de Pesquisa](http://www.divine-pride.net/database/item/7347/) |
...
| **Quests anteriores** | [Propriedade Maldita](Propriedade Maldita.md "Propriedade Maldita") [Infiltrando na Rekenber](Infiltrando na Rekenber.md "Infiltrando na Rekenber") |
| Premiação | |
| **[EXP base](Experiência de Base.md "Experiência de Base")** | 180.000 |
...
2. Aproxime-se da parede atrás do [NPC](NPC.md "NPC"), pisando nas coordenadas (lighthalzen 175,166)
...
8. Autorizada sua entrada fale mais de uma vez com o Guarda (yuno\_pre 95,71)
   ...
   - Insista na conversa até um [NPC](NPC.md "NPC") surgir.
...
13. Procure pelo Homem Ferido (lhz\_fild02 228,214)
    ...
    - Digite:
      - `Corporação Kafra`
    - Receba a [Pasta de Arquivos Selada](http://www.divine-pride.net/database/item/7343/).
14. Retorne a Funcionária Kafra e diga que o homem está em um lugar melhor. Ela devolverá a [Pasta de Arquivos Selada](http://www.divine-pride.net/database/item/7343/).
15. Reencontre o Presidente. Após a conversa, aguarde 3 minutos para falar com ele novamente.
    - Se já fez a missão [Propriedade Maldita](Propriedade Maldita.md "Propriedade Maldita"), você não precisará interrogar Shinokas.
    - Continue conversando com o [NPC](NPC.md "NPC") até a Secretária interromper a reunião.
    - Fale com o Presidente mais uma vez antes de prosseguir.
16. Dirija-se ao norte de [Lighthalzen](Lighthalzen.md "Lighthalzen"). Para aparecer a Mulher Misteriosa, é preciso andar nas coordenadas (lhz\_fild01 76,214)
...
23. Aproxime-se da Mulher Misteriosa, ao norte de [Lighthalzen](Lighthalzen.md "Lighthalzen").
24. Retorne ao Presidente.
25. Volte para a Mulher Misteriosa, você receberá a [Pasta de Arquivos Selada](http://www.divine-pride.net/database/item/7343/).
26. Entregue o item ao Presidente.
27. Reencontre a Mulher Misteriosa.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [Inspeção no Templo de Odin](Inspeção no Templo de Odin.md "Inspeção no Templo de Odin") | | | | | SetaVermelha | [A Rebelião](A Rebelião.md "A Rebelião") | | |
| [Fábrica de Einbroch](Fábrica de Einbroch.md "Fábrica de Einbroch") | SetaVermelha | [Propriedade Maldita](Propriedade Maldita.md "Propriedade Maldita") | SetaVermelha | O Presidente | SetaVermelha |
