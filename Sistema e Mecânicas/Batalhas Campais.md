...
Numa terra distante, à oeste de [Arunafeltz](../Redirecionamentos/Arunafeltz.md "Arunafeltz"), fica localizado o poderoso reino de Maroll.

O rei, Marcel Marollo VII não era apenas um grande líder, mas também um brilhante general.

Apesar de todo o seu poderio, Marollo VII não era imune ao tempo e sua enfermidade levou à necessidade da escolha de um sucessor.

Dos seus 9 filhos, 2 se destacaram como bons candidatos à sucessão: O talentoso e condecorado General Guillaume Marollo, e o brilhante e carismático diplomata Croix Marollo.

Incapazes de chegarem a um acordo, a disputa entre os dois príncipes ameaçava dividir o reino.

Para definir o conflito, o Rei Marollo decidiu promover uma competição que determinaria qual dos dois iria herdar a coroa.

Agora chegou a hora dos Leões Azuis do general Guillaume e das Águias Vermelhas do diplomata Croix partirem para a linha de frente e se enfrentarem numa verdadeira arena.

E para lutar nessa competição, cada príncipe passou a contratar vários aventureiros...

## Informações

As Batalhas Campais são disputadas por duas equipes, os vencedores receberão premiações em Pontos ou Emblemas que podem ser trocados por [itens](../Itens/Itens.md "Itens").
...
2. No Atrium, você encontrará os [NPCs](../Redirecionamentos/NPC.md "NPC") Príncipe Croix e General Guillaume, escolha seu lado nessa disputa!
...
| ![KriegervonMidgard1](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/8/80/KriegervonMidgard1.jpg)    Krieger von Midgard | - Batalhas de 5 contra 5 personagens. - São divididas entre 3 salas: níveis menor que 60; níveis 60 a 80; e acima do nível 80. - As batalhas têm duração de 5 minutos e vence quem possuir mais membros vivos ou reduzir a pontuação da adversária a zero. - As equipes começam com 1 ponto para cada um de seus membros, ela perde 1 ponto quando um membro morre. - Após a luta, os jogadores terão 30 segundos para retirar os pontos do [NPC](../Redirecionamentos/NPC.md "NPC") e sair do mapa. - Personagens de nível menor ou igual a 79 receberão 2 pontos por Vitória e nenhum por Derrota. - Personagens de nível maior ou igual a 80 receberão 5 pontos por Vitória e 1 por Derrota. |

### Regras

- [Habilidades](../Habilidades/Especiais/Habilidades.md "Habilidades") desabilitadas durante os períodos de [guerra](Guerra%20do%20Emperium.md "Guerra do Emperium") também não funcionam nas Batalhas Campais, incluindo [Corrida](../Habilidades/Especiais/Corrida.md "Corrida"), [Salto](../Habilidades/Especiais/Salto.md "Salto") e habilidades Solares, Lunares e Estelares.
- O dano de habilidades é reduzido em 30%.
- O dano de ataques de longa distância é reduzido em 25%.
- Personagens não podem ser [empurrados](Categoria-Habilidades que empurram.md "Categoria:Habilidades que empurram").
- [Cartas](../Itens/Cartas.md "Cartas") e [itens](../Itens/Itens.md "Itens") que tornam a [conjuração](../Redirecionamentos/Conjura%C3%A7%C3%A3o.md "Conjuração") ininterruptível não funcionam.
- Personagens nocauteados no campo de batalha são mandados para o Cemitério. Eles serão transportados de volta à luta após 25 segundos.
- Companheiros do mesmo exército podem ser vistos no minimapa, exibem barra de [HP](../Redirecionamentos/HP.md "HP") como em um [grupo](Grupo.md "Grupo") e podem comunicar-se entre si utilizando o comando `/battlechat`
- Nos mapas, os personagens são considerados:
...
Você pode trocar os Emblemas ou Pontos adquiridos por [itens](../Itens/Itens.md "Itens").

Existem prêmios específicos para cada Emblema e Ponto, isso significa que você não poderá trocar [armas](../Redirecionamentos/Armas.md "Armas") tipo **A**, usando Emblemas de Valor (que só trocam por armas tipo **B**).
...
Algumas [armas](../Redirecionamentos/Armas.md "Armas") do KVM possuem o efeito *Carniceiro*, que aumenta o dano físico contra oponentes das raças [humano](../Redirecionamentos/Humano.md "Humano") e [humanoide](../Redirecionamentos/Humanoide.md "Humanoide").

| [Refino](../Redirecionamentos/Refino.md "Refino") | Nv. 1 | Nv. 2 |
| --- | --- | --- |
| 6 | +4% | +9% |
| 7 | +9% | +16% |
| 8 | +16% | +25% |
...
---
*Categorias: Informações básicas, PvP*  
*Importado da [bROWiki](https://browiki.org/wiki/Batalhas_Campais) — revisão 41006*
