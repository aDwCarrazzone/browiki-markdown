...
|  |  |
| --- | --- |
| **![Calibre Letal](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/c/c8/Calibre_Letal.png) Calibre Letal** | |
| ![Calibre Letal](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/5/52/Calibre_Letal.gif) | |
| **Slug Shot / Destrucción Primordial** | |
| **ID** | RL\_SLUGSHOT (2570) |
| **Tipo** | Ofensiva |
| **Níveis** | 5 |
| **[SP](../Sem%20categoria/SP.md "SP")** | 76 + (Nv. da habilidade × 4) |
| **[Conjuração](../Sem%20categoria/Conjura%C3%A7%C3%A3o.md "Conjuração")** | 1 + (Nv. da hab. + 4) seg. |
...
| **Item** | ![25187.png](https://static.divine-pride.net/images/items/item/25187.png) 1 [Projétil Letal](http://www.divine-pride.net/database/item/25187/) |
| **Arma** | Espingarda |
| **Pré-requisitos** | |
| [![Tiro Neutralizante](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/9/90/Tiro_Neutralizante.png)](Tiro%20Neutralizante.md "Tiro Neutralizante") [Tiro Neutralizante](Tiro%20Neutralizante.md "Tiro Neutralizante") Nv. 3 | |

Consome 1 [Projétil Letal](http://www.divine-pride.net/database/item/25187/) para infligir um dano pesado.

Causa dano físico a distância e empurra um alvo 6 células para trás.

Possui um alcance de 9 células, mas ao tentar atingir alvos com distância maior que 3 células, haverá uma perda de [precisão](../Desambigua%C3%A7%C3%A3o/Precis%C3%A3o.md "Precisão") a cada célula distante.

O dano é aumentado conforme o [tamanho](../Sem%20categoria/Tamanho.md "Tamanho") do alvo.

| Nv. | [Precisão](../Desambigua%C3%A7%C3%A3o/Precis%C3%A3o.md "Precisão") por célula | Dano base | | [Conjuração variável](../Sem%20categoria/Conjura%C3%A7%C3%A3o%20vari%C3%A1vel.md "Conjuração variável") | [SP](../Sem%20categoria/SP.md "SP") |
| --- | --- | --- | --- | --- | --- |
| Personagens | Monstros |
| 1 | -10% | 2.000% | 1.200% | 5 segundos | 80 |
| 2 | -9% | 4.000% | 2.400% | 6 segundos | 84 |
| 3 | -8% | 6.000% | 3.600% | 7 segundos | 88 |
| 4 | -7% | 8.000% | 4.800% | 8 segundos | 92 |
| 5 | -6% | 10.000% | 6.000% | 9 segundos | 96 |

### Fórmula

`Dano em alvos pequenos = (Dano base ×2)%`

`Dano em alvos médios = (Dano base ×3)%`

`Dano em alvos grandes = (Dano base ×4)%`

## Notas

- O dano não é afetado pela [propriedade](../Sem%20categoria/Propriedade.md "Propriedade") do projétil equipado.
- A redução da [precisão](../Desambigua%C3%A7%C3%A3o/Precis%C3%A3o.md "Precisão") é contabilizada a partir da 4ª célula distante do alvo.
- Armas relacionadas:
