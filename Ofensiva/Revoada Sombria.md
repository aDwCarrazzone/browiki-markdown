...
|  |  |
| --- | --- |
| **![Revoada Sombria](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/d/d8/Revoada_Sombria.png) Revoada Sombria** | |
| [Arquivo:Revoada Sombria.gif](https://browiki.org/index.php?title=Especial:Carregar_arquivo&wpDestFile=Revoada_Sombria.gif "Arquivo:Revoada Sombria.gif") | |
| **Fatal Shadow Claw / Garra Sombría Fatal** | |
| **ID** | SHC\_FATAL\_SHADOW\_CROW (5294) |
| **Tipo** | Ofensiva |
| **Níveis** | 10 |
...
| **Pré-requisitos** | |
| - [![Facada](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/3/31/Facada.png)](Facada.md "Facada") [Facada](Facada.md "Facada") Nv. 5 - [![Impacto Cratera](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/7/75/Impacto_Cratera.png)](Impacto%20Cratera.md "Impacto Cratera") [Impacto Cratera](Impacto%20Cratera.md "Impacto Cratera") Nv. 5 | |

Voa como um Corvo Sombrio para cima do oponente.

Conjura [Garra Sombria](Garra%20Sombria.md "Garra Sombria") na área ao redor do alvo.

Inimigos sofrerão dano físico corpo a corpo.

Se forem das raças [Dragão](../Sem%20categoria/Drag%C3%A3o.md "Dragão") e [Humanoide](../Sem%20categoria/Humanoide.md "Humanoide"), receberão um dano bônus adicional.
...
No momento do ataque, [CRIT](../Sem%20categoria/CRIT.md "CRIT") +100.

| Nv. | [ATQ](../Sem%20categoria/ATQ.md "ATQ") | | Área |
| --- | --- | --- | --- |
| Normal | Bônus |
| 1 | 650% | 950% | 3x3 células |
| 2 | 1.300% | 1.900% |
| 3 | 1.950% | 2.850% |
| 4 | 2.600% | 3.800% |
| 5 | 3.250% | 4.750% | 5x5 células |
| 6 | 3.900% | 5.700% |
| 7 | 4.550% | 6.650% |
| 8 | 5.200% | 7.600% |
| 9 | 5.850% | 8.550% | 7x7 células |
| 10 | 6.500% | 9.500% |

### Fórmula

`ATQ = [Dano base + (POD × 10)] x (Nv. de base ÷ 100]%`

## Notas

- Esta é uma **[Habilidade Crítica](Categoria-Habilidades críticas.md "Categoria:Habilidades críticas").**
- A duração de [Garra Sombria](Garra%20Sombria.md "Garra Sombria") é de 10 segundos.
- O nível de [Garra Sombria](Garra%20Sombria.md "Garra Sombria") conjurado é igual ao nível aprendido.
