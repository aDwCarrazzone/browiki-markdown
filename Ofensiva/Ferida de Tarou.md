...
|  |  |
| --- | --- |
| **![Ferida de Tarou](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/e/e5/Ferida_de_Tarou.png) Ferida de Tarou** | |
| ![Ferida de Tarou](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/6/62/Ferida_de_Tarou.gif) | |
| **Scar of Tarou / Cicatriz de Tarou** | |
| **ID** | SU\_SCAROFTAROU (5032) |
| **Tipo** | Ofensiva |
| **Níveis** | 5 |
...
| **Ícone** | ![I Leptospirose](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/7/79/I_Leptospirose.png) |
| **Pré-requisitos** | |
| [![Impulso de Arclouse](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/5/5c/Impulso_de_Arclouse.png)](../Suporte/Impulso%20de%20Arclouse.md "Impulso de Arclouse") [Impulso de Arclouse](../Suporte/Impulso%20de%20Arclouse.md "Impulso de Arclouse") Nv. 3 | |

Invoca o espírito do rato Tarou.

Causa dano físico a distância em um alvo único.

Tem 10% de chance de infligir *Leptospirose*.
...
- Inflige 2 segundos de [Atordoamento](../Sem%20categoria/Atordoamento.md "Atordoamento").
- Causa perda de [HP](../Sem%20categoria/HP.md "HP") a cada segundo, durante 9 segundos.
  - Fórmula: `Perda de HP = [Nv. da habilidade + (DES do usuário ÷ 25)]%`
- Pode ser removida por [Curar](../Suporte/Curar.md "Curar"), [Medicar](../Suporte/Medicar.md "Medicar"), [Curatio](../Suporte/Curatio.md "Curatio"), [Sopro Divino](../Suporte/Sopro%20Divino.md "Sopro Divino") e [Gênese](../Ativa/G%C3%AAnese.md "Gênese").
- Alvos afetados receberão o dobro de dano da Ferida de Tarou.
- O efeito não mata os alvos afetados.
- Alvos com zero de [HP](../Sem%20categoria/HP.md "HP") perderão zero de [HP](../Sem%20categoria/HP.md "HP") continuamente até o fim do efeito.
...
- Monstros Chefes não podem ser afetados pela Leptospirose, mas receberão o dobro de dano da habilidade.
...
- Equipamentos relacionados:
  - ![28380.png](https://static.divine-pride.net/images/items/item/28380.png) [Colar da Semente](http://www.divine-pride.net/database/item/28380/)
