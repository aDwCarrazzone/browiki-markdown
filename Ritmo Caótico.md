---
title: "Ritmo Caótico"
source: https://browiki.org/wiki/Ritmo_Ca%C3%B3tico
namespace: 0
revision: 46682
...
|  |  |
| --- | --- |
| **Ritmo Caótico Ritmo Caótico** | |
| Ritmo Caótico | |
| **Down Tempo / Ritmo Lento** | |
| **ID** | BD\_ETERNALCHAOS (308) |
| **Tipo** | Ativa |
| **Níveis** | 1 |
| **[SP](SP.md "SP")** | 120 |
...
| **Ícone** | I Ritmo Caótico |
| **Áudio** | <https://browiki.org/wiki/Arquivo:Ritmo_Ca%C3%B3tico.mp3> |
| **Pré-requisitos** | |
| - [Lamento de Loki](Lamento de Loki.md "Lamento de Loki") [Lamento de Loki](Lamento de Loki.md "Lamento de Loki") Nv. 1 | |

Inicia um dueto desafinado.

Oponentes na área de 9x9 células ao redor do usuário terão 100% de chance de terem a [DEF](DEF.md "DEF") zerada.

## Nota

- Não afeta [monstros](Monstros.md "Monstros") do tipo chefe.
- Reduz completamente toda a [DEF](DEF.md "DEF") de [atributos](Atributos.md "Atributos") e de [equipamentos](Equipamentos.md "Equipamentos").
- Só pode ser usada em mapas de [PvP](PvP.md "PvP") e [Guerra do Emperium](Guerra do Emperium.md "Guerra do Emperium").
- O áudio original da habilidade é da música [Toccata e Fugue em D menor](https://www.youtube.com/watch?v=_FXoyr_FyFw), de J.S. Bach.
- Sobre Duetos:
