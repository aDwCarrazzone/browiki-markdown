---
title: "Mudança de Classe: Executores"
source: https://browiki.org/wiki/Mudan%C3%A7a_de_Classe%3A_Executores
namespace: 0
revision: 44683
...
| JQ ico Mudança de Classe: Executores | |
| --- | --- |
| Requisitos mínimos | |
| **Nv. de base** | 99 |
| **Nv. de classe** | 70 |
| **Tipo** | Classe |
| **Classe** | [Algoz](Algoz.md "Algoz") |
| **[Zeny](Zeny.md "Zeny")** | 5.000z (*Opcional*) |
| Premiação | |
| **[Itens](Itens.md "Itens")** | 2795.png 1 [Anel de Maçã Verde](http://www.divine-pride.net/database/item/2795/)  5755.png 1 [Som do Silêncio](http://www.divine-pride.net/database/item/5755/)  12106.png 1 [Caixa de Joias](http://www.divine-pride.net/database/item/12106/) |
| **Recompensa** | Classe alterada para [Sicário](Sicário.md "Sicário") |
...
| [Quests](Quests.md "Quests") | [Mudança de Classe: Mercenários](Mudança de Classe- Mercenários.md "Mudança de Classe: Mercenários") · [Mudança de Classe: Sicários](Mudança de Classe- Sicários.md "Mudança de Classe: Sicários") · Mudança de Classe: Executores [Novas habilidades](Novas habilidades- Gatunos e evoluções.md "Novas habilidades: Gatunos e evoluções") |
