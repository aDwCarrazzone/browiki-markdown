---
title: "Banquete de Njord"
source: https://browiki.org/wiki/Banquete_de_Njord
namespace: 0
revision: 46678
...
|  |  |
| --- | --- |
| **Banquete de Njord Banquete de Njord** | |
| Banquete de Njord | |
| **Mental Sensing / Percepción Mental** | |
| **ID** | BD\_RICHMANKIM (307) |
| **Tipo** | Ativa |
| **Níveis** | 5 |
| **[SP](SP.md "SP")** | 56 - (Nv. da habilidade × 6) |
...
| **Ícone** | I Banquete de Nord |
| **Áudio** | <https://browiki.org/wiki/Arquivo:Banquete_de_Njord.mp3> |
| **Pré-requisitos** | |
| - [Ode a Siegfried](Ode a Siegfried.md "Ode a Siegfried") [Ode a Siegfried](Ode a Siegfried.md "Ode a Siegfried") Nv. 3 | |

Inicia um dueto ganancioso.

O usuário e membros do [grupo](Grupo.md "Grupo") receberão mais [experiência](Experiência.md "Experiência") de base e de classe ao derrotar [monstros](Monstros.md "Monstros").

| Nv. | [EXP](EXP.md "EXP") | [SP](SP.md "SP") |
| --- | --- | --- |
| 1 | +20% | 62 |
| 2 | +30% | 68 |
| 3 | +40% | 74 |
...
- Afeta [monstros](Monstros.md "Monstros") do tipo chefe.
- É acumulativo com outros consumíveis que aumentam a [EXP](EXP.md "EXP").
- Não funciona se a [EXP](EXP.md "EXP") adquirida for proveniente de [quests](Quests.md "Quests"), como as do [Grupo do Éden](Grupo do Éden.md "Grupo do Éden").
- O áudio original da habilidade é da música [Freight Train Fiddlin](https://www.youtube.com/watch?v=f9vZrbsXqec), do álbum "Bluegrass Delight".
- Sobre Duetos:
