...
source: https://browiki.org/wiki/Amea%C3%A7a_Fantasma
namespace: 0
revision: 46591
...
| **Área** | 7x7 células |
| **Pré-requisitos** | |
| - [Ocultação](Ocultação.md "Ocultação") [Ocultação](Ocultação.md "Ocultação") Nv. 5 - [Passo Sombrio](Passo Sombrio.md "Passo Sombrio") [Passo Sombrio](Passo Sombrio.md "Passo Sombrio") Nv. 5 | |

Aumenta seus instintos sombrios.

Realiza um ataque ameaçador.

Atinge apenas oponentes ocultos ([esconderijo](Esconderijo.md "Esconderijo"), [furtividade](Furtividade.md "Furtividade")...).

Causa dano físico corpo a corpo equivalente a 300% do [ATQ](ATQ.md "ATQ").
