---
title: "Estilista"
source: https://browiki.org/wiki/Estilista
namespace: 0
revision: 44401
...
Basta dirigir-se para um Estilista, indicado com um ![Map barbea](images/c/c7/Map_barbea.png) nas cidades de [Prontera](Prontera.md "Prontera"), [Lighthalzen](Lighthalzen.md "Lighthalzen"), [Alberta](Alberta.md "Alberta"), [Juno](Juno.md "Juno"), [Lasagna](Lasagna.md "Lasagna") ou [Rachel](Rachel.md "Rachel").

Não há limitação de nível para mudar seu visual, basta falar com um Estilista para abrir a Loja de Estilos.

- Salões de Beleza:
  - Verônica (alberta\_in 55,142)
  - Príncipe Shammi (lhz\_in02 100,143)
  - Jojovich (prt\_in 243,168)
  - Max (yuno\_in04 186,21)
  - Asobis (ra\_in01 186,148)
  - Longka (lasagna 134,113)
- Selecione a opção "*Mudar meu estilo*" para abrir a Loja de Estilos.
  - Você pode selecionar os cortes e cores de cabelo, mas alguns cortes dependem de [zenys](Zeny.md "Zeny") e de cupons.
  - Para mudar a cor da roupa, você precisa do Cupom comprado via [JoyCoins](JoyCoins.md "JoyCoins").
  - Para mudar de roupa, clique no botão "Roupa Alternativa", disponível somente para Classes 3.

## Cabelos

- Os cabelos de 1 a 23 custam apenas 100.000 [zenys](Zenys.md "Zenys") pela mudança.
- Mudar a cor do cabelo custa 100.000 [zenys](Zenys.md "Zenys").
  - Existe uma [NPC](NPC.md "NPC") Cabeleireira ao lado de todo Estilista que cobra mais barato, apenas levar umas [Tinturas](Tinturas.md "Tinturas") e 1.000 [zenys](Zenys.md "Zenys").
  - Ela também muda o corte de cabelo do 1 a 23, mas do jeito antigo:
    - Coletando vários itens que não valem a pena perder tempo coletando, mais rápido só pagar 100.000 [zenys](Zeny.md "Zeny").
  - Para iniciantes, existe o [NPC](NPC.md "NPC") Otto, que troca seu cabelo do 1 ao 23 com o [Cupom de Cabeleireiro do Calouro](http://www.divine-pride.net/database/item/6593/).
...
- O corte de cabelo 32 custa apenas 100.000 [zenys](Zenys.md "Zenys").
- **Os cortes de cabelo 33 a 45 não podem ser comprados ainda.**
- Para os [Dorams](Doram.md "Doram"):
  - Os pelos de número 2, 5, 6, 7, 8, 9 e 10 não podem ser pintados.
- Números com um **X** são de cabelos ainda não estão disponíveis.
...
- A cor da roupa só pode ser alterada através do ![6046.png](http://static.divine-pride.net/images/items/item/6046.png) [Cupom de Tintura](http://www.divine-pride.net/database/item/6046/), adquirido via [JoyCoins](JoyCoins.md "JoyCoins").
...
- Para trocar pela roupa alternativa, basta levar o ![6959.png](http://static.divine-pride.net/images/items/item/6959.png) [Cupom de Roupa](http://www.divine-pride.net/database/item/6959/) para um Estilista.
  - O Cupom pode ser adquirido através de uma [Conquista](Conquista.md "Conquista").
...
![Cor Aprendiz Evoluções](images/5/5f/Cor_Aprendiz_Evoluções.png)
...
![Cor Espadachins Evoluções](images/3/3b/Cor_Espadachins_Evoluções.png)

- Ver **[montaria](https://browiki.org/wiki/Discuss%C3%A3o%3AEstilista#Espadachins_e_evoluções "Discussão:Estilista")**.

### Magos e evoluções

![Cor Magos Evoluções](images/d/d4/Cor_Magos_Evoluções.png)
...
![Cor Arqueiros Evoluções](images/a/ac/Cor_Arqueiros_Evoluções.png)
...
![Cor Taekwons Evoluções](images/3/3a/Cor_Taekwons_Evoluções.png)
...
![Cor Justiceiros Evoluções](images/6/6e/Cor_Justiceiros_Evoluções.png)

- Ver **[montaria](https://browiki.org/wiki/Discuss%C3%A3o%3AEstilista#Justiceiros_e_evoluções "Discussão:Estilista")**.

### Ninjas e evoluções

![Cor Ninjas Evoluções](images/b/bc/Cor_Ninjas_Evoluções.png)
...
![Cor Invocadores Evoluções](images/1/1f/Cor_Invocadores_Evoluções.png)
...
| Sistemas | [Conquistas](Conquistas.md "Conquistas") · [RODEX](RODEX.md "RODEX") · [Replay](Replay.md "Replay") · [Navegação](Navegação.md "Navegação") · [Lojinha de Rua](Lojinha de Rua.md "Lojinha de Rua") · Estilista · [Combinação](Combinação.md "Combinação") · [Grupo](Grupo.md "Grupo") · [Clã](Clã.md "Clã") · [Reputação](Reputação.md "Reputação") |
