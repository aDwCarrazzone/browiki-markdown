...
source: https://browiki.org/wiki/Dan%C3%A7a_do_Ventre
namespace: 0
revision: 46665
...
| **Tipo** | Ativa |
| **Níveis** | 5 |
| **[SP](SP.md "SP")** | 32 + (Nv. da habilidade × 3) |
...
| **Arma** | Chicote |
| **Pré-requisitos** | |
| - [Encerramento](Encerramento.md "Encerramento") [Encerramento](Encerramento.md "Encerramento") Nv. 1 - [Lições de Dança](Lições de Dança.md "Lições de Dança") [Lições de Dança](Lições de Dança.md "Lições de Dança") Nv. 1 | |

Dança sensualmente.

Tem chance de drenar o [SP](SP.md "SP") dos oponentes na área de 9x9 células ao seu redor.

| Nv. | Drena | Chance | [SP](SP.md "SP") |
| --- | --- | --- | --- |
| 1 | -12% | 25% | 35 |
| 2 | -14% | 30% | 38 |
| 3 | -16% | 35% | 41 |
