...
source: https://browiki.org/wiki/B%C3%AAn%C3%A7%C3%A3o_Protetora
namespace: 0
revision: 46689
...
|  |  |
| --- | --- |
| **Bênção Protetora Bênção Protetora** | |
| Bênção Protetora | |
| **Sheltering Bliss / Dicha Protectora** | |
| **ID** | CG\_MOONLIT (395) |
| **Tipo** | Suporte |
| **Níveis** | 5 |
| **[SP](SP.md "SP")** | 20 + (Nv. da habilidade × 10) |
| **Duração** | 15 + (Nv. da habilidade × 10) |
| **Alvo** | Usuário |
| **Empurra** | 2 células |
| **Área** | 9x9 células |
| **Arma** | Chicote ou Instrumento musical |
| **Requisito** | [Grupo](Grupo.md "Grupo") com outro artista |
| **Áudio** | <https://browiki.org/wiki/Arquivo:B%C3%AAn%C3%A7%C3%A3o_Protetora.mp3> |
| **Pré-requisitos** | |
| - Menestréis [Concentrar](Concentrar.md "Concentrar") [Concentrar](Concentrar.md "Concentrar") Nv. 5 [Lições de Música](Lições de Música.md "Lições de Música") [Lições de Música](Lições de Música.md "Lições de Música") Nv. 7 - Ciganas [Concentrar](Concentrar.md "Concentrar") [Concentrar](Concentrar.md "Concentrar") Nv. 5 [Lições de Dança](Lições de Dança.md "Lições de Dança") [Lições de Dança](Lições de Dança.md "Lições de Dança") Nv. 7 | |

Inicia uma apresentação atípica em dupla.

Os artistas ficarão imóveis, mas irão empurrar oponentes e impede que eles se aproximem da área.

Enquanto estiver ativa, cancela a regeneração natural de [SP](SP.md "SP") do usuário.

Manter a performance ativa drena [SP](SP.md "SP") do usuário a cada 10 segundos.

| Nv. | Duração | Dreno | [SP](SP.md "SP") |
| --- | --- | --- | --- |
| 1 | 20 segundos | -4 | 30 |
| 2 | 25 segundos | -8 | 40 |
| 3 | 30 segundos | -12 | 50 |
...
- Não funciona contra [monstros](Monstros.md "Monstros") Chefes.
- Não protege os artistas de ataques a distância.
- Não pode ser usada na [Guerra do Emperium](Guerra do Emperium.md "Guerra do Emperium"), [Torre sem Fim](Torre sem Fim.md "Torre sem Fim") e perto de obstáculos.
- Esta habilidade é do tipo Dupla e possui algumas particularidades:
  - A dupla só poderá ser executada se o [Menestrel](Menestrel.md "Menestrel") e a [Cigana](Cigana.md "Cigana") estiverem lado a lado, no mesmo [grupo](Grupo.md "Grupo") e terem aprendido a habilidade.
  - Pode ser interrompida se trocar de arma, sofrer [efeitos negativos](Efeitos negativos.md "Efeitos negativos") ou receber dano maior que 25% do [HP](HP.md "HP").
  - Se houver uma diferença de nível da habilidade entre o [Menestrel](Menestrel.md "Menestrel") e a [Cigana](Cigana.md "Cigana"), prevalecerá a de menor nível.
...
| |  |  | | --- | --- | | [Ciganaspartyicn](Ciganas.md "Ciganas") | [Ciganas](Ciganas.md "Ciganas") | | [Bastão de Hermod](Bastão de Hermod.md "Bastão de Hermod") · [Controle de Marionete](Controle de Marionete.md "Controle de Marionete") · [Destino nas Cartas](Destino nas Cartas.md "Destino nas Cartas") · [Vocação Musical](Vocação Musical.md "Vocação Musical") · [Vulcão de Flechas](Vulcão de Flechas.md "Vulcão de Flechas") Bênção Protetora |
