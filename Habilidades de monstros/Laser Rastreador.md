...
A cada 1 segundo, o alvo sofrerá dano fixo de 30.000 de [HP](../Sem%20categoria/HP.md "HP").

Oponentes ao redor de 7x7 células ao redor do alvo também sofrerão dano.
...
- *Confira a lista de [monstros](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Monstros.md "Monstros") que usam [Laser Rastreador](http://www.divine-pride.net/database/skill/773)*
- O ataque cai na célula em que o personagem se encontra. Caso o jogador se mova antes do ataque, ele não será atingido.
