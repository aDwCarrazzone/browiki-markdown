...
|  |  |
| --- | --- |
| **![Riscar Fósforo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/0/01/Riscar_F%C3%B3sforo.png) Riscar Fósforo** | |
| ![Riscar Fósforo](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/9/92/Riscar_F%C3%B3sforo.gif) | |
| **Hiss / Siseo** | |
| **ID** | SU\_HISS (5047) |
| **Tipo** | Suporte |
| **Níveis** | 5 |
| **[SP](../Sem%20categoria/SP.md "SP")** | 54 − (Nv. da habilidade × 4) |
| **[Conjuração](../Sem%20categoria/Conjura%C3%A7%C3%A3o.md "Conjuração")** | 1 + 0 seg. |
| **Pós-conjuração** | 1 segundo |
| **Recarga** | 210 − (Nv. da habilidade × 30) |
| **Duração** | 3 ~ 5 segundos |
| **Alvo** | Usuário |
| **Ícone** | ![I Chiado](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/7/75/I_Chiado.png) |
| **Pré-requisitos** | |
| Nível base 100. [![Poder da Fauna](https://cdn.jsdelivr.net/gh/aDwCarrazzone/browiki-images@main/c/cc/Poder_da_Fauna.png)](../Passiva/Poder%20da%20Fauna.md "Poder da Fauna") [Poder da Fauna](../Passiva/Poder%20da%20Fauna.md "Poder da Fauna") Nv. 1 | |

Fica em estado de alerta, oferecendo ao usuário e membros do grupo na tela:

- [Esquiva perfeita](../Sem%20categoria/Esquiva%20perfeita.md "Esquiva perfeita") +50 por 3 segundos.
- Acelera o movimento temporariamente.

| Nv. | Movimento | Recarga | [SP](../Sem%20categoria/SP.md "SP") |
| --- | --- | --- | --- |
| 1 | 3 segundos | 180 segundos | 50 |
| 2 | 150 segundos | 46 |
| 3 | 4 segundos | 120 segundos | 42 |
| 4 | 90 segundos | 38 |
| 5 | 5 segundos | 60 segundos | 34 |

## Notas

- Precisa estar acima do nível de base 100 para aprender a habilidade.
- O efeito pode ser removido por [Gênese](../Ativa/G%C3%AAnese.md "Gênese").
- Funciona em [Homunculus](../Homunculus/Homunculus.md "Homunculus") de [Alquimistas](../P%C3%A1ginas%20que%20usam%20a%20etiqueta%20Tabber%20do%20analisador%20sint%C3%A1tico/Alquimistas.md "Alquimistas") que estiverem no [grupo](../Informa%C3%A7%C3%B5es%20b%C3%A1sicas/Grupo.md "Grupo").
- "*Riscar fósforo*" é uma gíria usada por donos de gatos para indicar o barulho ou estranhamento do animal com pessoas ou outros objetos, [veja vídeo de exemplo](https://www.youtube.com/watch?v=5i5E4UXPB7Q).
- Sombrios relacionados:
  - ![24409.png](https://static.divine-pride.net/images/items/item/24409.png) [Greva Sombria de Fauna](http://www.divine-pride.net/database/item/24409/)
