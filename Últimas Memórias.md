...
source: https://browiki.org/wiki/%C3%9Altimas_Mem%C3%B3rias
namespace: 0
revision: 41632
...
| NQ ico Últimas Memórias | |
| --- | --- |
| Realize o último pedido de Y.S.F.01 e entregue os pertences dos seus amigos aos respectivos familiares. | |
| Requisitos mínimos | |
| **Nv. de base** | 100 |
| **Tipo** | Normal |
| **[Itens](Itens.md "Itens")** | 23087.png 1 [Pochete de Couro](http://www.divine-pride.net/database/item/23087/) |
| **Quests anteriores** | [Terra Gloria](Terra Gloria.md "Terra Gloria") |
| Premiação | |
| **[EXP base](Experiência de Base.md "Experiência de Base")** | 600.000 |
| **[EXP classe](Experiência de Classe.md "Experiência de Classe")** | 600.000 |

1. Após completar o [Laboratório Werner](Laboratório Werner.md "Laboratório Werner") no modo história e ter recebido a [Pochete de Couro](http://www.divine-pride.net/database/item/23087/), você deverá entregar os itens aos seus respectivos [NPCs](NPC.md "NPC").
2. Cada entrega garante 100.000 de [EXP](EXP.md "EXP") base e de classe.
