---
title: "Gatchaman"
source: https://browiki.org/wiki/Gatchaman
namespace: 0
revision: 47162
...
| **Caça** | Ver tabela |
| Premiação | |
| **[Itens](Itens.md "Itens")** | 1002382.png [Botão Míssil Midga](http://www.divine-pride.net/database/item/1002382/) |

1. Converse com o Guia da Fenda Anômala (morocc 196,261)

   :   ![Gatchaman01](images/8/89/Gatchaman01.png)
2. Após aceitar ajudá-lo, siga pela navegação conversando com os [NPCs](NPC.md "NPC") indicados.
3. Seguindo a conversa até o sul de [Morroc](Morroc.md "Morroc"), aproxime-se de Galaring.
...
5. A [navegação](Navegação.md "Navegação") levará seu personagem até a Fenda Anômala (morocc 23,188)

   :   ![Gatchaman04](images/0/01/Gatchaman04.png)
6. Prepare-se para a [instância](Instância.md "Instância")!
   ...
   4. Elimine o [Galaring Bestial](http://www.divine-pride.net/database/monster/22677/) para encerrar a [instância](Instância.md "Instância").
7. Retorne para a Fenda Anômala (morocc 23,188) e converse com os [NPCs](NPC.md "NPC").
...
- [Galaring Bestial](http://www.divine-pride.net/database/monster/22677/) está disponível somente na [instância](Instância.md "Instância") dele.
...
- As recompensas podem ser resgatadas no [NPC](NPC.md "NPC") Armazém.
