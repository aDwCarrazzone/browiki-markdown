---
title: "Sibilo de Eir"
source: https://browiki.org/wiki/Sibilo_de_Eir
namespace: 0
revision: 46703
...
|  |  |
| --- | --- |
| **Sibilo de Eir Sibilo de Eir** | |
| Sibilo de Eir | |
| **Circle of Nature / Círculo de la Naturaleza** | |
| **ID** | WM\_SIRCLEOFNATURE (2423) |
| **Tipo** | Suporte |
| **Níveis** | 5 |
| **[SP](SP.md "SP")** | 38 + (Nv. da habilidade × 4) |
...
| **Ícone** | I Sibilo de Eir |
| **Áudio** | <https://browiki.org/wiki/Arquivo:Sibilo_de_Eir.mp3> |
| **Pré-requisitos** | |
| - [Domínio Musical](Domínio Musical.md "Domínio Musical") [Domínio Musical](Domínio Musical.md "Domínio Musical") Nv. 1 | |

Recita um cântico de circulação da natureza.

Todos os membros do [grupo](Grupo.md "Grupo") ao redor de 31x31 células vão ter a regeneração natural de [HP](HP.md "HP") acelerada.

| Nv. | Regen. de [HP](HP.md "HP") | [SP](SP.md "SP") |
| --- | --- | --- |
| 1 | +50% | 42 |
| 2 | +100% | 46 |
| 3 | +150% | 50 |
...
`Regeneração de HP = {(Nv. da habilidade × 50) + [(Nv. de Domínio Musical ÷ 2) × 20]}%`

## Notas

- Não pode ser removida por [Desencantar](Desencantar.md "Desencantar"), mas por [Gênese](Gênese.md "Gênese").
- Por alguma razão, não pode estar ativa simultaneamente com as habilidades de Coral.
