---
title: "Talho Eterno"
source: https://browiki.org/wiki/Talho_Eterno
namespace: 0
revision: 47026
...
| **Alvo** | Oponente |
| **Alcance** | 2 células |
| **Requisito** | [Reflexo de Combate](Reflexo de Combate.md "Reflexo de Combate") |
| **Pré-requisitos** | |
| - [Reflexo de Combate](Reflexo de Combate.md "Reflexo de Combate") [Reflexo de Combate](Reflexo de Combate.md "Reflexo de Combate") Nv. 3 - [Senso das Sombras](Senso das Sombras.md "Senso das Sombras") [Senso das Sombras](Senso das Sombras.md "Senso das Sombras") Nv. 5 - [Adagas Voadoras](Adagas Voadoras.md "Adagas Voadoras") [Adagas Voadoras](Adagas Voadoras.md "Adagas Voadoras") Nv. 3 | |

Só pode ser usada em estado de [Reflexo](Reflexo de Combate.md "Reflexo de Combate").
...
Se [Carrasco Sombrio](Carrasco Sombrio.md "Carrasco Sombrio") estiver ativo, o dano é aumentado.

É possível causar dano crítico com a habilidade.

A chance do ataque crítico é a metade do [CRIT](CRIT.md "CRIT") do usuário.

| Nv. | [ATQ](ATQ.md "ATQ") por corte | |
| --- | --- | --- |
| Normal | [Carrasco Sombrio](Carrasco Sombrio.md "Carrasco Sombrio") |
| 1 | 350% | 500% |
| 2 | 700% | 1.000% |
| 3 | 1.050% | 1.500% |
| 4 | 1.400% | 2.000% |
...
- Se o usuário for alvo de [Gênese](Gênese.md "Gênese") ou [Desencantar](Desencantar.md "Desencantar") no meio da contagem de cortes, ela será resetada para 1.
- Equipamentos relacionados:
  - ![490164.png](http://static.divine-pride.net/images/items/item/490164.png) [Cordão do Executor](http://www.divine-pride.net/database/item/490164/)
